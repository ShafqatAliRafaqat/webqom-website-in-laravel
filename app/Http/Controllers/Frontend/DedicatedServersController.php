...
class DedicatedServersController extends Controller
{
    ...
    public function configDedicate() {
        $plans = PlanFeature::with('details')->where('page','dedicated servers')->get();
        return view('frontend.server_config_dedicated',compact('plans'));
    }
    /**
