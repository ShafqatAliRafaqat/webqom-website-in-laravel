...
class ServicesEnquiryController extends Controller
{
  function __construct() {
     ...
     */
    protected $view_folder="admin/service_enquiry.";
    protected $page_name="Services Enquiry";
    public function index($type='default',$per_page=10)
    {
      ...
      $services_enquiry=ServiceEnquiry::paginate($per_page);
      return view($this->view_folder.$view_file,['services_enquiry'=> $services_enquiry,
        'page_name'=>$page_name,
        'per_page'=>$per_page,
     ...
     * @return \Illuminate\Http\Response
     */
    public function store($type='single',Request $request)
    {
