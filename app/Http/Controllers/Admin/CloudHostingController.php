...
class CloudHostingController  extends Controller
{
    ...
    public function index()
    {
      ...
      $page_cms = Page::where('name','cloud hosting')->first();
      $plan_features = PlanFeature::where('page','cloud hosting')->paginate(5);
      $cloud_hosting_plan = Plan::where('page','cloud hosting')->paginate(5);
      $general_features = GeneralFeature::where('page','cloud hosting')->paginate(5);
      $recent_update=$this->recent_update_time();
      return view('admin.cloud_hosting.list', compact('plan_features','recent_update','general_features','page_cms','cloud_hosting_plan'));
    }
    ...
    public function create()
    {
      ...
      return view('admin.cloud_hosting.create',compact('categories'));
    }
    ...
    public function store(Request $request)
    {
     //return $request->all();
      ...
      $cloud_hosting->page='cloud hosting';
    ...
    public function edit($id)
    {
      ...
      return view('admin.cloud_hosting.edit', compact('plan','categories'));
    }
  ...
  public function image_update(Request $request)
  {
   ...
   $icon_image=Input::file('image_file');
      ...
      {
        $recent_date_timestamp=Page::select('updated_at')->where('name','cloud hosting')->orderBy('updated_at','desc')->first();
    ...
    */
    public function cloud_hosting_plan(Request $request)
    {
      ...
      $this->validate($request,[
        ...
        $plan->page= 'cloud hosting';
        $plan->save();
    }
    public function update_cloud_hosting_plan(Request $request,$id)
    {
      //return $request->promo_behaviour;
      $current_currency_other=$request->current_currency_other;
      if ($current_currency_other=="") {
    ...
    {
        $cms = Page::where('name','cloud hosting')->first();
        $cms->content=$cms->temp;
        $plans = Plan::where('page','cloud hosting')->where('status',1)->take(3)->get();
        $featured_plans = PlanFeature::where('page','cloud hosting')->where('status',1)->get();
        $general_features = GeneralFeature::where('page','cloud hosting')->get();
        $recent_update=$this->recent_update_time();
        return view('frontend.cloud_hosting', compact('indexplans','general_features','plans','featured_plans','cms'));
    }
