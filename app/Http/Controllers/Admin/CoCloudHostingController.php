...
class CoCloudHostingController  extends Controller
{
    /**
    ...
    private $view_folder='admin.co_cloud_hosting.';
    ...
    public function index()
    {
      ...
      $page_cms = Page::where('name',$this->page_name)->first();
      $plan_features = PlanFeature::where('page',$this->page_name)->paginate(5);
      $cloud_hosting_plan = Plan::where('page',$this->page_name)->paginate(5);
      $general_features = GeneralFeature::where('page',$this->page_name)->paginate(5);
      $recent_update=$this->recent_update_time();
      return view($this->view_folder.'list', compact('plan_features','recent_update','general_features','page_cms','cloud_hosting_plan'));
    }
    ...
    public function store(Request $request)
    {
     //return $request->all();
      ...
      $cloud_hosting->page=$this->page_name;
    ...
    public function edit($id)
    {
      ...
      return view($this->this->view_folder.'edit', compact('plan','categories'));
    }
  ...
  public function image_update(Request $request)
  {
    ...
    */
    ...
    {
        $cms = Page::where('name',$this->page_name)->first();
        $cms->content=$cms->temp;
        $plans = Plan::where('page',$this->page_name)->where('status',1)->take(3)->get();
        $featured_plans = PlanFeature::where('page',$this->page_name)->where('status',1)->get();
        $general_features = GeneralFeature::where('page',$this->page_name)->get();
        $recent_update=$this->recent_update_time();
