...
array('url'=>'javascript:viod','name'=>'Index Plan- New'),
...
@section('page_header','Index Plan')
    ...
    <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Index Plan <i class="fa fa-angle-right"></i> Add New</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="frm_genrel" class="form-horizontal" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <input type="text" name="name_line1" value="{{old('name_line1')}}" class="form-control" placeholder="eg. VPS">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="name_line2" value="{{old('name_line2')}}" class="form-control" placeholder="eg. Hosting">
                                            ...
                                            <div class="form-group">
                                                <label for="inputFirstName" class="col-md-3 control-label">URL Link</label>
                                                    <div class="col-md-6">
                                                        <div class="xss-margin"></div>
                                                        <input type="text" value="{{old('url')}}" name="url" class="form-control" placeholder="eg. 1">
                                    ...
                                    <div class="form-horizontal" id="frm_pricing">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="xss-margin"></div>
                                                        <div class="radio-list">
                                                            <label><input id="inlineCheckbox1" type="radio"  onchange="select_currency()" name="pricing_currency" value="RM" checked="checked"/>&nbsp; RM</label>
                                                            <label><input id="inlineCheckbox1" type="radio" value="USD" name="pricing_currency" />&nbsp; USD, please specify the conversion rate below to RM </label>
                                                            <input name="pricing_currency_other" value="{{old('pricing_currency_other')}}" type="text" class="form-control">
                                                            <div class="xss-margin"></div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="xss-margin"></div>
                                                        <div class="radio-list">
                                                            <label><input id="inlineCheckbox1"  type="radio" name="recurring_currency" value="RM" checked="checked"/>&nbsp; RM</label>
                                                            <label><input id="inlineCheckbox1" type="radio" name="recurring_currency" value="USD"/>&nbsp; USD, please specify the conversion rate below to RM </label>
                                                            <input name="recurring_currency_other" value="{{old('recurring_currency_other')}}" type="text" class="form-control">
                                                            <div class="xss-margin"></div>
                                                            <div class="text-blue text-12px">eg. 1 USD = 3.50 RM</div>
...
@section('custom_scripts')
    <script type="text/javascript">
        ...
        function select_currency() {
            //alert($('input[name="pricing_currency"]:checked').val());
        }
    </script>
@endsection