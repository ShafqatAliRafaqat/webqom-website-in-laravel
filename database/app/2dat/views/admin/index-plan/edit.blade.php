<?php $page='index-plan';
$breadcrumbs=[
array('url'=>url('admin/index-plan'),'name'=>'Index Plan'),
array('url'=>'javascript:viod','name'=>'Index Plan- Edit'),

];
?>

@extends('layouts.admin_layout')
@section('title','Admin | Index Plan Edit')
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="pull-left"> Last updated: <span id="updated_at" class="text-blue">
                {{date("d M,Y",strtotime($indexplan->updated_at))." @ ".date("h:i a",strtotime($indexplan->updated_at))}}
            </span> </div>
            <div class="clearfix"></div>
            @if ($errors->any())
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div  class="tab-pane fade in active">
                    <form id="frm_genrel" class="form-horizontal" action="{{url('/admin/index-plan/')}}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="indexplan_id" id="indexplan_id" value="{{$indexplan->id}}">
                        <div class="portlet">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <div data-on="success" data-off="primary" class="make-switch">
                                                    <input type="checkbox" name="status"  @if($indexplan->status==1) checked="checked" @endif/>
                                                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                   <input type="text" name="name_line1" value="{{$indexplan->name_line1}}" class="form-control" placeholder="eg. VPS">
           ...
           <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" name="name_line2" value="{{$indexplan->name_line2}}" class="form-control" placeholder="eg. Hosting">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <img width="70px" id="img_icon_image" src="{{url('').'/storage/index-plan/icon_images/'.$indexplan->icon_image}}" >
                    <input accept="image/png" id="icon_image_file" name="icon_image" type="file"/> 
                    @if($indexplan->icon_image!="")
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" value="{{$indexplan->sort_order}}" name="sort_order" class=" numOnly form-control" placeholder="eg. 1">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="xss-margin"></div>
                    <div class="radio-list">
                        <label><input @if($indexplan->enable_plan_button=='None') checked="" @endif id="inlineCheckbox1" name="enable_plan_button"  type="radio" value="None"/>&nbsp; None</label>
                        <label><input id="inlineCheckbox1" name="enable_plan_button" type="radio" value="Get Started!" @if($indexplan->enable_plan_button=='Get Started!') checked="" @endif/>&nbsp; Get Started!</label>
                        <label><input id="inlineCheckbox1" @if($indexplan->enable_plan_button=='Ask for Quote') checked="" @endif name="enable_plan_button" type="radio" value="Ask for Quote"/>&nbsp; Ask for Quote</label>
                        <label><input @if($indexplan->enable_plan_button=='Order Now') checked="" @endif id="inlineCheckbox1" name="enable_plan_button" type="radio" value="Order Now"/>&nbsp; Order Now</label>
                        <label><input id="inlineCheckbox4" @if($indexplan->enable_plan_button=='other') checked="" @endif type="radio" name="enable_plan_button" value="other"/>&nbsp; Others, please specify:</label>
                        <input name="enable_plan_button_other" value="{{$indexplan->enable_plan_button_other}}" type="text" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="xss-margin"></div>
                    <input type="text" value="{{$indexplan->url}}" name="url" class="form-control" placeholder="eg. 1">
...
<div class="portlet">
    ...
    <div class="portlet-body">
                ...
                <div class="form-horizontal" id="frm_pricing">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="xss-margin"></div>
                            <div class="radio-list">
                                <label><input name="pricing_type" @if($indexplan->price_type=='Free') checked="" @endif  id="inlineCheckbox1" type="radio" value="Free" checked="checked"/>&nbsp; Free</label>
                                <label><input name="pricing_type" @if($indexplan->price_type=='One Time') checked="" @endif id="pricing_one_time" type="radio" value="One Time"/>&nbsp; One Time</label>
                                <label><input name="pricing_type" @if($indexplan->price_type=='Recurring') checked="" @endif id="inlineCheckbox2" type="radio" value="Recurring" />&nbsp; Recurring</label>
                            </div>
                    ...
                    <div hidden="" class="one_time_price">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-6">
                                <div class="xss-margin"></div>
                                <div class="radio-list">
                                    <label><input id="inlineCheckbox1" @if($indexplan->pricing_currency=='RM') checked="" @endif type="radio" name="pricing_currency" value="RM" checked="checked"/>&nbsp; RM</label>
                                    <label><input id="inlineCheckbox1"  @if($indexplan->pricing_currency=='USD') checked="" @endif  type="radio" value="USD" name="pricing_currency" />&nbsp; USD, please specify the conversion rate below to RM </label>
                                    <input name="pricing_currency_other"  value="{{$indexplan->pricing_currency_other}}" type="text" class="form-control">
                                    <div class="xss-margin"></div>
      ...
      <div hidden="" class="recurring_price">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="xss-margin"></div>
                <div class="radio-list">
                    <label><input id="inlineCheckbox1" @if($indexplan->recurring_currency=='RM') checked="" @endif   type="radio" name="recurring_currency" value="RM" checked="checked"/>&nbsp; RM</label>
                    <label><input id="inlineCheckbox1" @if($indexplan->recurring_currency=='USD') checked="" @endif type="radio" name="recurring_currency" value="USD"/>&nbsp; USD, please specify the conversion rate below to RM </label>
                    <input name="recurring_currency_other" value="{{$indexplan->recurring_currency_other}}" type="text" class="form-control">
                    <div class="xss-margin"></div>
                    <div class="text-blue text-12px">eg. 1 USD = 3.50 RM</div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
             <input name="recurring_first_month" value="{{$indexplan->recurring_first_month}}" type="text" class="form-control" placeholder="0.00">
     ...
     <div class="form-group">
        ...
        <div class="col-md-6">
         <input name="recurring_first_year" value="{{$indexplan->recurring_first_year}}" type="text" class="form-control" placeholder="0.00">
...
<div id="pricing_table" hidden="" class="table-responsive mtl">
                                                    <table class="table table-hover table-striped">
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td>Setup Fee</td>
                                                          <td><input type="text" value="{{$indexplan->setup_fee_one_time}}" name="setup_fee_one_time" class="form-control" placeholder="0.00"></td> 
                                                          <td><input type="text" value="{{$indexplan->setup_fee_monthly}}" name="setup_fee_monthly" class="form-control" placeholder="0.00"></td>
                                                          <td class="recurring_price_fields"><input value="{{$indexplan->setup_fee_annually}}"  name="setup_fee_annually" type="text" class="form-control" placeholder="0.00"></td>
                                                          <td class="recurring_price_fields"><input value="{{$indexplan->setup_fee_biennially}}" name="setup_fee_biennially" type="text" class="form-control" placeholder="0.00"></td>
                                                          <td class="recurring_price_fields"><input value="{{$indexplan->setup_fee_triennially}}" name="setup_fee_triennially" type="text" class="form-control" placeholder="0.00"></td>
                                                          <td></td>
                                                        </tr>
                                                        <tr>
                                                          <td>Price</td>
                                                          <td><input type="text" name="price_one_time" value="{{$indexplan->price_one_time}}" class="form-control" placeholder="0.00"></td>
                                                          <td><input type="text"  class="form-control"  value="{{$indexplan->price_monthly}}" name="price_monthly" placeholder="0.00"></td>
                                                          <td class="recurring_price_fields"><input type="text"  value="{{$indexplan->price_annually}}" name="price_annually" class="form-control" placeholder="0.00"></td>
                                                          <td class="recurring_price_fields"><input type="text"  value="{{$indexplan->price_biennially}}" class="form-control" name="price_biennially" placeholder="0.00"></td>
                                                          <td class="recurring_price_fields"><input type="text"  value="{{$indexplan->price_triennially}}" name="price_triennially" class="form-control" placeholder="0.00"></td>
...
<div class="form-actions">
  <div class="col-md-offset-5 col-md-7"> <a href="javascript:void" onclick="submit_data()" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="{{url('/admin/index-plan')}}" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
</div>  
...
<script type="text/javascript">
    ...
    $(document).on('submit', '#frm_genrel', function(event) {
        ...
        $.ajax({
            url: base_url+'/admin/index-plan/{{$indexplan->id}}',
            type: 'PUT',
  ...
  scrollTop: $(".page-content").offset().top
    ...
    $("#icon_image_file").change(function(event) {
        ...
        .done(function(response) {
            ...
            $('#img_icon_image').attr('src',"{{url('').'/storage/index-plan/icon_images/'}}"+response);
        })
        .fail(function(response) {
