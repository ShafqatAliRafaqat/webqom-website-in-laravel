...
<div class="page-content">
              ...
              <div class="portlet">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6">
                                  <div class="input-icon"><i class="fa fa-key"></i>
                                    ...
                                    <span class="text-10px">(Password length should be atleast 12 characters)</span>
                ...
                <div class="portlet-body">
                  ...
                  <div class="table-responsive mtl">
                            ...
                            @foreach($clients as $client)
                               @if($client->client)
                                    ...
                                    <tr id="clienttbl_row_{{$client->id}}">
                                      ...
                                      <td>{{$client->client->account_type}}</td>
                                      <td><span class="label label-xs label-<?php echo  $client->client->status==1 ? "success" :"red" ?>"><?php echo  $client->client->status==1 ? "Active" :"Inactive" ?></span></td>
                                          ...
                                          <div id="modal-delete-{{$client->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <p><strong>#{{$client->client->client_id or ""}}:</strong> {{$client->client->first_name}} {{$client->client->last_name}}<br/>
                                                      <strong>Company:</strong> {{$client->client->company}} </p>
                                                  <div class="form-actions">
                    ...
                    <?php if ($clients instanceof \Illuminate\Pagination\LengthAwarePaginator){ ?>
                      <span>Showing  {{$clients->firstItem()}} to {{$clients->lastItem()}} of {{$clients->total()}}</span>
        ...
        function open_modal_delete_selected() {
            ...
            </script>response<style type="text/css">
