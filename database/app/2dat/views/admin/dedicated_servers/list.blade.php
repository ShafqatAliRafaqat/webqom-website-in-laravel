...
<div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Dedicated Servers <i class="fa fa-angle-right"></i> Edit</h2>
              ...
              <h4 class="block-heading">Dedicated Hosting Plans &amp; General Features Listing</h4>
              <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#hosting-plans" data-toggle="tab">Dedicated Hosting Plans</a></li>
          ...
          <div class="portlet">
                      ...
                      <div id="modal-delete-selected-plan-feature" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p><strong>#1:</strong> CPU [Dual Processors]</p>
                              <div class="form-actions">
                                          ...
                                          <div class="form">
                                            <form class="form-horizontal">
                                              ...
                                              <div class="form-group">
                                                <label class="col-md-3 control-label">Plan Feature <span class="text-red">*</span></label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="eg. RAM" value="CPU [Dual Processors]">
                                                </div>
                                              </div> 
                                              <div class="form-actions">
                                                <div class="col-md-offset-5 col-md-8"> <a href="#" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                  ...
                  <div class="portlet">
                    <div class="portlet-header">
                      <div class="caption">Dedicated Hosting Plans Listing</div>
                      <p class="margin-top-10px"></p>
                      <a href="dedicated_server_plan_new.html" class="btn btn-success">Add New Plan &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                      <div class="btn-group">
                        <button type="button" class="btn btn-primary">Delete</button>
                        <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                        <ul role="menu" class="dropdown-menu">
                      ...
                      <div id="modal-delete-selected-plan" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p><strong>#1:</strong> Enterprise 3</p>
                              <div class="form-actions">
                                <div class="col-md-offset-4 col-md-8"> <a href="#" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                              </div>
                            </div>
                                        ...
                                        <div id="modal-delete-1" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade alileft">
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <p><strong>#3:</strong> Enterprise 3</p>
                                                <div class="form-actions">
                                                  <div class="col-md-offset-4 col-md-8"> <a href="#" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                </div>
                                              </div>
                        ...
                        <table class="table table-hover table-striped">
                          ...
                          <tbody>
                            <tr>
                              <td>1</td>
                              <td><span class="label label-xs label-success">Active</span></td>
                              <td>Dedicated Server Features</td>
                                          ...
                                          <div class="form">
                                            <form class="form-horizontal">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                   <input type="text" class="form-control" value="Dedicated Server Features"> 
                                                </div>
                                              </div>
                      ...
                      <div id="modal-delete-selected-general-feature" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p><strong>#1:</strong> For your Business Needs</p>
                              <div class="form-actions">
                                <div class="col-md-offset-4 col-md-8"> <a href="#" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                              </div>
                            </div>
                                            ...
                                            <div class="form">
                                              <form class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Feature Title <span class="text-red">*</span></label>
                                                    <div class="col-md-6">
                                                      <input type="text" class="form-control" placeholder="eg. Ultra-Fast Platform" value="For your Business Needs">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                    <label class="col-md-3 control-label">Feature Description</label>
                                                    <div class="col-md-6">
                                                      <textarea class="form-control">Optimized server equipment to solve difficult business tasks.</textarea>
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
                                                    <label class="col-md-3 control-label">Insert CSS Icon or </label>
                                                    <div class="col-md-6">
                                                        <div class="text-blue border-bottom">Please choose <strong>ONE</strong> of the following options for "Feature Icon".</div>
                                                      <div class="margin-top-5px"></div>
                                                      <input type="text" class="form-control" id="inputContent" placeholder="eg. fa-rocket or icon-anchor" value="icon-briefcase">
                                                      <div class="help-block">Please refer here for complete <a href="icons_sevices.html" target="_blank">icon options.</a></div>
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
     ...
     $.ajax({
       ...
       data: {'_token':'{{csrf_token()}}',
         ...
         .done(function(response) {
          if (publish==0) {
            window.open(base_url+"/dedicated_servers");
          }
