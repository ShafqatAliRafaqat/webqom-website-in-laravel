...
Route::group(['namespace' => 'Admin', 'middleware' => 'noCache'], function () {
    ...
    Route::group(['prefix' => 'admin/cmspages'], function () {
        Route::get('admin/cmspages', ['as' => 'cmspages', 'uses' => 'CmsPagesController@index']);        
        Route::get('datatable', ['uses' => 'CmsPagesController@datatable']);
        Route::get('datatable/getposts', ['as' => 'datatable.getposts', 'uses' => 'CmsPagesController@getPosts']);
        Route::get('cmspages/create', ['as' => 'cmspages.create', 'uses' => 'CmsPagesController@create']);
        Route::post('cmspages/store', ['as' => 'cmspages.store', 'uses' => 'CmsPagesController@store']);
    ...
    Route::group(['prefix' => 'admin/domain_pricing'], function () {
        ...
        Route::get('/addons/{per_page?}', 'DomainPricingController@index')->where(['per_page' => '[0-9]+']);
    ...
    Route::group(['prefix' => 'admin/email88/'], function () {
        ...
        Route::POST('get_details/', 'Email88Controller@get_details');
        Route::POST('get_details_hp/', 'DedicatedServersController@get_details_hp');
    ...
    Route::group(['prefix' => 'admin/web88ir/'], function () {
        ...
        Route::POST('get_details/', 'Web88irController@get_details');
        Route::POST('get_details_hp/', 'DedicatedServersController@get_details_hp');
    ...
    //10 August 2017
    #Route::resource('admin/ecommerce', 'EcommerceController');
    Route::resource('admin/web88ir', 'Web88irController');
    Route::resource('admin/email88', 'Email88Controller');
});
