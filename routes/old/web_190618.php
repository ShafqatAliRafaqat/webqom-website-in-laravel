...
Route::group(['namespace' => 'Admin', 'middleware' => 'noCache'], function () {
	...
	/**
	 * This routes is creating by Acep
	 * Why I did like this ?
	 * because we don't user any versioning like Git, So it's to hard to solve if we have some problem with conflict files
	 * After we using Git, I will fix the routes
	 */
...
Route::group(['namespace' => 'Frontend'], function () {
	...
	Route::get('/domain_configuration', 'DomainConfigController@index');
