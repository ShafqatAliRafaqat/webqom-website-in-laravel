...
<div class="page-content">
  <div class="row">
    <div class="col-lg-12">
      <h2>{{$page_name}} <i class="fa fa-angle-right"></i> Edit</h2>
     ...
     <div hidden="" style="margin-top: 10px" id="success_message_cms" class="messages alert alert-success alert-dismissable">
      ...
      <div class="pull-left"> Last updated: <span id="updated_date" class="text-blue">{{$recent_update}}</span> </div>
      <div class="clearfix"></div>
      <p></p>
      <div class="portlet">
    ...
    <ul id="myTab" class="nav nav-tabs">
      ...
      @if(strpos(url()->current(),'email88') !== false) 
         <li><a href="#email88-special-features" data-toggle="tab">Email88 New & Special Features</a></li>
      @endif
      ...
      @if($page_cms->is_ssl_page==1)<li><a href="#faq" data-toggle="tab">FAQ</a></li>@endif
    </ul>
      ...
      <div  id="hosting-plans" class="tab-pane fade in active">
                      ...
                      <form id="plan_feature_frm" method="post" class="form-horizontal">
                        ...
                        <div class="form-actions">
                          <div class="col-md-offset-5 col-md-8">
                              <a href="javascript:void" id="save_feature_plan" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp;
          ...
          <div class="portlet-body">
            <div class="table-responsive mtl">
              <table class="table table-hover table-striped">
                <thead>
                  <tr>
                    <th width="1%"><input id="pf_checkbox" onchange="check_all('pf_checkbox')" type="checkbox"/></th>
                    <th>#</th>
                    <th>Status</th>
                    <th>Plan Feature</th>
                    <th>Action</th>
                ...
                <tbody>
                  <form id="delete_client">
                     {!!csrf_field()!!}
                                    ...
                                    <tr>
                                      <td><input class="pf_checkbox" name="id[]" value="{{$i->id}}" type="checkbox"/></td>
                        ...
                        <div id="modal-delete-plan-feature-{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <p><strong>#{{$count_plan_features}}:</strong> {{$i->title}}</p>
                                <div class="form-actions">
        ...
        <div class="portlet">
          <div class="portlet-header">
            ...
            <p style="margin-top: 32px" class="margin-top-10px"></p>
            <a href="{{url('admin/services/new/'.$page_slug)}}" class="btn btn-success">Add New Plan &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
            <div class="btn-group">
              <button type="button" class="btn btn-primary">Delete</button>
              <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
              <ul role="menu" class="dropdown-menu">
              ...
              <table class="table table-hover table-striped">
                ...
                <tbody>
                  <form id="delete_hosting_plans">
                    ...
                    <tr>
                      <td><input name="id_hp[]" class="plan_checkbox" value="{{$i->id}}" type="checkbox"/></td>
                      <td>{{$i->id}}</td>
                      <td><span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span></td>
                      ...
                      @if($page_cms->is_ssl_page==1)
                        <td>
                          @if($i->price_type=='Recurring')
                            <span>3 Years @ </span> {{$i->price_triennially or '0'}}<span>/yr</span>
                            <span>2 Years @ </span> {{$i->price_biennially or '0'}}<span>/yr</span><br>
                            <span>1 Years @ </span> {{$i->price_annually or '0'}}<span>/yr</span><br>
                          @endif
                      ...
                      @else
                        ...
                        <span>RM</span> {{$i->price_annually or '0'}}<span>/yr</span>@endif
                      ...
                      @endif
                        ...
                        <td><a href="{{url('/admin/services/edit/'.$i->id.'/'.$page_slug)}}"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-plan-hosting-{{$i->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                          <!--Modal Edit plan feature start-->

                          <!--END MODAL Edit plan feature -->
                          <!--Modal delete start-->
                          <div id="modal-delete-plan-hosting-{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-actions">
                                    <div class="col-md-offset-4 col-md-8"> <a href="javascript:void" onclick="delete_single_hp({{$i->id}})" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                  </div>
                                </div>
                              </div>
                            </div>
        ...
        <div id="faq" class="tab-pane fade">
                  ...
                  <div class="portlet">
                    <div class="portlet-header">
                      ...
                      <a href="javascript:void" onclick ="store_faq(0)" data-target="#modal-add-faq" data-toggle="modal" class="btn btn-success">Add New &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                      <div class="btn-group">
                        <button type="button" class="btn btn-primary">Delete</button>
                        <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                        <ul role="menu" class="dropdown-menu">
                          <li><a href="javascript:void;" onclick="modalDeleteSelectedFaq()">Delete selected item(s)</a></li>
                          <li class="divider"></li>
                          <li><a href="#" data-target="#modal-delete-all" data-toggle="modal">Delete all</a></li>
                        </ul>
                      </div>
                            ...
                            <div class="modal-body">
                              <div class="form">
                                ...
                                <input type="hidden" name="page" value="{{$page_name}}">
                                  ...
                                  <div class="form-group">
                                    <label class="col-md-3 control-label">FAQ Title <span class="text-red">*</span></label>
                                    <div class="col-md-6">
                                      <input type="text" name="title" class="form-control" placeholder="eg. What is a SSL Certificate?">
                                      <p class="red_error" id="faq_title"></p>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="col-md-3 control-label">Content <span class="text-red">*</span></label>
                                    <div class="col-md-9">
                      ...
                      <div id="modal-delete-selected-faq" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                              <h4 id="modal-login-label4" class="modal-title"><a href=""><i class="fa fa-exclamation-triangle"></i></a> Are you sure you want to delete the FAQ item(s)? </h4>
                            </div>
                            ...
                            <div class="modal-body" id="delete-unselected-body-faq">
							  ...
							  <p id="selected_zero" style="" class="alert alert-danger">Please select at least one item for delete</p>
							  <div class="form-actions" id="delete-selected-buttons" style="display: none;">
							...
							<div class="modal-body" id="delete-selected-body-faq" style="display:none;"> 
							  <div class="form-actions" id="delete-selected-buttons">
								<div class="col-md-offset-4 col-md-8"> <button type="button" onclick="deletebulkfaqitems()" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
							  </div>
							</div>
                          </div>
                        </div>
                    ...
                    <div class="portlet-body">
                      <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            <thead>
                  <tr>
                    <th width="1%"><input id="faq_checkbox" onchange="check_all('faq_checkbox')" type="checkbox"/></th>
                    <th>#</th>
                    <th>Status</th>
                    <th>Title</th>
                    <th class="">Action</th>
                ...
                <tbody>
                  <form id="delete_hosting_plans">
                    ...
                    @foreach($faq as $i)
                    <tr>
                      <td><input name="id_hp[]" class="faq_checkbox" value="{{$i->id}}" type="checkbox"/></td>
                      <td>{{$i->id}}</td>
                      <td><div id="statusval_<?php echo $i->id; ?>">{{$i->title}}</div></td>
                      <td><span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span></td>

                        <td><a href="javascript:void" onclick ="store_faq({{$i->id}})"   title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-plan-hosting-{{$i->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                          <!--Modal Edit plan feature start-->
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-actions">
                                    <div class="col-md-offset-4 col-md-8"> <a href="javascript:void" onclick="delete_faq({{$i->id}})" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                  </div>
                                </div>
                              </div>
                            </div>
        ...
        <div id="general-features" class="tab-pane fade">
          ...
          <div class="portlet">
            <div class="portlet-header">
              ...
              <p class="margin-top-10px"></p>
              <a href="javascript:void" onclick="add_general_feature(0)" class="btn btn-success">Add New &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
              <div class="btn-group">
                <button type="button" class="btn btn-primary">Delete</button>
                <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                <ul role="menu" class="dropdown-menu">
              ...
              <div class="portlet-body">
                <div class="table-responsive">
                  <table class="table table-hover table-striped">
                    <thead>
                      <tr>
                        <th width="1%"><input id="gff_checkbox" onchange="check_all('gff_checkbox')" type="checkbox"></th>
                        <th>#</th>
                        <th>Status</th>
                        <th>Title</th>
                        <th>Action</th>
                    ...
                    <tbody>
                      <form id="delete_general_features">
                        ...
                        <?php $count_gf++;?>
                        <tr>
                          <td><input type="checkbox" data-count="{{$count_gf}}" class="gff_checkbox" value="{{$i->id}}" name="id_gf[]"></td>
                          <td>{{$count_gf}}</td>
                          <td><span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span></td>
                          <td>{{$i->title}}</td>
                          <td><a href="javascript:void" onclick="edit_general_feature({{$i->id}},0)" data-hover="tooltip" data-placement="top"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-general-feature-{{$i->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                            ...
                            <div id="modal-delete-general-feature-{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p><strong>#{{$count_gf}}:</strong>{{$i->title}}</p>
                                    <div class="form-actions">
              ...
              <div class="portlet @if($page_cms->is_ssl_page==0) hidden @endif">
                    <div class="portlet-header">
                      ...
                      <p class="margin-top-10px"></p>
                      <a href="javascript:void" onclick="add_general_feature(1)" class="btn btn-success">Add New &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                      <div class="btn-group">
                        <button type="button" class="btn btn-primary">Delete</button>
                        <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                        <ul role="menu" class="dropdown-menu">
                          <li><a href="javascript:void" onclick="gf_open_modal_delete_selected(1)">Delete selected item(s)</a></li>
                          <li class="divider"></li>
                          <li><a href="#" data-target="#modal-delete-all" data-toggle="modal">Delete all</a></li>
                        </ul>
                      </div>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      <form id="delete_general_features_ssl">
                        ...
                        <?php $count_gf++;?>
                        <tr>
                          <td><input type="checkbox" class="gff_checkbox" value="{{$i->id}}" name="id_gf[]"></td>
                          <td>{{$count_gf}}</td>
                          <td><span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span></td>
                          <td>{{$i->title}}</td>
                          <td><a href="javascript:void" onclick="edit_general_feature({{$i->id}},1)" data-hover="tooltip" data-placement="top"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-count="{{$count_gf}}" data-placement="top" title="Delete" data-target="#modal-delete-general-feature-{{$i->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="delete-selected-body">
          ...
          <div class="form-actions" id="delete-selected-buttons">
            ...
            <button type="button" id="delete_bulk_gf" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>
            <button type="button" id="delete_bulk_gf_ssl" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>
              ...
              <div class="col-md-6">
                ...
                <div class="help-block">Please refer here for complete <a href="icons_sevices.html" target="_blank">icon options.</a>
                    ...
                    <div class="col-md-9">
                      ...
                      <a id="gf_img_delete" href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-icon" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                      ...
                      <div id="modal-delete-icon" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p><img src="../images/about_us/icon_cloud_app.png" id="gf_img_edit_modal" alt="Ultra-Fast Platform" class="img-responsive"></p>
                              <div class="form-actions">
                                  <div class="col-md-offset-4 col-md-8"> <a href="#" class="btn btn-red" id="gf_delete_icon_button" onclick="delete_gf_icon()">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                              </div>
                            </div>
                          </div>
                        </div>
  ...
  <script type="text/javascript">
	...
	function deletebulkfaqitems(){
		...
		$.post(base_url+"/admin/services/deletebulkfaqs", {ids:post,_token:'{{csrf_token()}}'}).done(function(e){
			location.reload(); 
		});
	}
