...
$breadcrumbs = [
    ...
    array('url' => 'javascript:void', 'name' => 'Ecommerce- Edit'),
];
?>
@extends('layouts.admin_layout')
@section('title','Admin | Ecommerce- Edit')
@section('content')
@section('page_header','Services')
<div class="page-content">
    <div class="row">
        <div class="col-lg-12">
            <h2>Ecommerce <i class="fa fa-angle-right"></i> Edit</h2>
            ...
            <h4 class="block-heading">Ecommerce Plans &amp; General Features Listing</h4>
            ...
            <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#hosting-plans" data-toggle="tab">Ecommerce Plans</a></li>
            ...
            <div id="myTabContent" class="tab-content">
                <div id="hosting-plans" class="tab-pane fade in active">
                    ...
                    <div class="portlet">
                        <div class="portlet-header">
                            <div class="caption">Ecommerce Plans Listing</div>
                            <p style="margin-top: 32px" class="margin-top-10px"></p>
                            <a href="{{url('admin/ecommerce/create')}}" class="btn btn-success">Add New Plan &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary">Delete</button>
                                <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                                <ul role="menu" class="dropdown-menu">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <form id="delete_hosting_plans">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{url('/admin/ecommerce/edit/'.$i->id)}}"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-plan-feature-{{$i->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                                <!--Modal Edit plan feature start-->
...
<script type="text/javascript">
                                                ...
                                                event.preventDefault();
                                                        $.ajax({
                                                        url: base_url + '/admin/ecommerce/new',
                                                                type: 'POST',
                                                ...
                                                $.ajax({
                                                url: base_url + '/admin/ecommerce/update',
                                                        type: 'POST',
                                                ...
                                                $('#delete_single_button').attr("disabled", true);
                                                        $.ajax({
                                                        url: base_url + '/admin/ecommerce/delete',
                                                                type: 'POST',
                                                ...
                                                $.ajax({
                                                url: base_url + '/admin/ecommerce/get_details',
                                                        type: 'POST',
                                                ...
                                                /*get seleccted users details*/
                                                $.ajax({
                                                url: base_url + '/admin/ecommerce/get_details_hp',
                                                        type: 'POST',
                                                ...
                                                $('#delete_bulk_hp').attr("disabled", true);
                                                        $.ajax({
                                                        url: base_url + '/admin/ecommerce/delete_hp',
                                                                type: 'POST',
                                                                data: $("#delete_hosting_plans").serialize(),
                                                        })
                                                        .done(function() {
                                                        ...
                                                        $.ajax({
                                                        url:base_url + '/admin/ecommerce/delete_all_plans',
                                                                type: 'POST',
                                                                data: {'_token': csrf_token},
                                                        })
                                                                .done(function() {
                                                ...
                                                $.ajax({
                                                url: base_url + '/admin/ecommerce/update_sort',
                                                        type: 'POST',
