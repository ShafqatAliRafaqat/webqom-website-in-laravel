 <?php if ($services_enquiry instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
<?php $per_page=$services_enquiry->perPage(); ?>
<?php else: ?>
<?php $per_page=10; ?>
<?php endif ?>
<?php $page='domains';
...
@section('title','Admin | Services Enquiry - Listing')
@section('content')
...
<div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Services Enquiry<i class="fa fa-angle-right"></i> Listing</h2>
              ...
              <div class="portlet">
                ...
                <div class="portlet-body">
                  ...
                  <div class="table-responsive mtl">
                    ...
                    <table id="clients_list" class="table table-hover table-striped">
                      <thead>
                        <tr>
                          ...
                          <th><a href="#sort by client id">Name </a></th>
                          <th><a href="#sort by client id">Company </a></th>
                          <th><a href="#sort by client id">Email </a></th>
                          <th><a href="#sort by client id">Website </a></th>
                          <th><a href="#sort by client id">Enquiry Services </a></th>
                          <th>Action</th>
                        </tr>
                      </thead>
                      <tbody>

                      @if(!empty($services_enquiry))
                             <?php if ($services_enquiry instanceof \Illuminate\Pagination\LengthAwarePaginator){ ?>
                                <?php $count=$services_enquiry->firstItem(); ?>
                              <?php }else{ ?>
                                <?php $count=1; ?>
                              <?php } ?>
                            @foreach($services_enquiry as $i)
                    ...
                    <?php if ($services_enquiry instanceof \Illuminate\Pagination\LengthAwarePaginator){ ?>
                      <span>Showing  {{$services_enquiry->firstItem()}} to {{$services_enquiry->lastItem()}} of {{$services_enquiry->total()}}</span>
                      <span class="pull-right">{{$services_enquiry->links()}}</span>
                    <?php }else{ ?>
                      <span>Total records: {{count($services_enquiry)}}</span>
                    <?php } ?>
          ...
          <!-- end row -->
            ...
            page_url=base_url+'/admin/services_enquiry/';
