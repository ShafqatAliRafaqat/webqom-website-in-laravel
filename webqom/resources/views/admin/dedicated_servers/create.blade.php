...
array('url'=>'javascript:void','name'=>'Dedicated Servers- Add New'),
];
?>

@extends('layouts.admin_layout')
@section('title','Admin | Dedicated Servers- New')
@section('content')
@section('page_header','Services')
    ...
    <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Dedicated <i class="fa fa-angle-right"></i> Add New</h2>
                                                                      ...
                                                                      <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                          ...
                                                                          <!--<select class="form-control">
                                                                            ...
                                                                            note to programmer: the list of plan features is added from "dedicated_servers_edit.html" page.-->
                                                                        </div>
                                                                      </div>
                                                                      <!--<div class="form-group">
                                                                        <label class="col-md-3 control-label">Description </label>
...
@section('custom_scripts')
    <script type="text/javascript">
        ...
        $(document).on('submit', '#frm_genrel', function(event) {
            ...
            $.ajax({
                url: base_url+'/admin/dedicated_servers/new_plan',
                type: 'POST',
                data: formData,
