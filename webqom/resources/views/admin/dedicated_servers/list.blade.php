...
array('url'=>'javascript:void','name'=>'Dedicated Servers- Edit'),
];
?>
...
<div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              ...
              <h4 class="block-heading">Dedicated Servers Plans &amp; General Features Listing</h4>
              ...
              <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#hosting-plans" data-toggle="tab">Dedicated Servers Plans</a></li>
              ...
              <div id="myTabContent" class="tab-content">
                <div id="hosting-plans" class="tab-pane fade in active">
                  ...
                  <div class="portlet">
                    <div class="portlet-header">
                      <div class="caption">Dedicated Servers Plans Listing</div>
                      <p style="margin-top: 32px" class="margin-top-10px"></p>
                      <a href="{{url('admin/dedicated_servers/new')}}" class="btn btn-success">Add New Plan &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                      <div class="btn-group">
                        <button type="button" class="btn btn-primary">Delete</button>
                        <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                        <ul role="menu" class="dropdown-menu">
...
<script type="text/javascript">
  ...
  $(document).on('submit', '#plan_feature_frm', function(event) {
    ...
    $.ajax({
      url: base_url+'/admin/dedicated_servers/new',
      type: 'POST',
  ...
  $(document).on('click', '#edit_plan_feature', function(event) {
      $.ajax({
      url: base_url+'/admin/dedicated_servers/update',
      type: 'POST',
    ...
    */var left_content = CKEDITOR.instances.left_content.getData();
    ...
    console.log(left_content)
     ...
     function delete_single(id,type) {
                      ...
                      $.ajax({
                      url: base_url+'/admin/dedicated_servers/delete',
                      type: 'POST',
                  ...
                  if (selected<1) {
                    ...
                    $.ajax({
                      url: base_url+'/admin/dedicated_servers/get_details',
                      type: 'POST',
                ...
                function open_modal_delete_selected_hp() {
                  ...
                  if (selected<1) {
                    ...
                    /*get seleccted users details*/
                    $.ajax({
                      url: base_url+'/admin/dedicated_servers/get_details_hp',
                      type: 'POST',
      ...
      $(document).on('click', '#delete_bulk_hp', function(event,form_id) {
                  ...
                  if (selected<1) {
                    ...
                    $.ajax({
                      url: base_url+'/admin/dedicated_servers/delete_hp',
                      type: 'POST',
               ...
               $.ajax({
                 url:base_url+'/admin/dedicated_servers/delete_all_plans',
                 type: 'POST',
                 data: {'_token': csrf_token},
               })
               .done(function() {
         ...
         $.ajax({
           url: base_url+'/admin/dedicated_servers/update_sort',
           type: 'POST',
