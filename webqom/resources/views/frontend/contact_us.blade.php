    ...
    <div class="cforms alileft">
        ...
        <form type="POST" id="gsr-contact" onSubmit="return valid_datas( this );">
            <div class="one_half">
                ...
                <label class="input">
                    <select>
                        ...
                        <option>Social Media Application</option>
            ...
            <label class="textarea">
                <textarea rows="3" name="message" id="message" style="width:98%"></textarea>
            </label>
    
            <div class="clearfix"></div>
            
            <div class="g-recaptcha" data-sitekey="6LdTaF0UAAAAAGvmUSyhAERM9FnooWGWVKjwK8jM"></div>
