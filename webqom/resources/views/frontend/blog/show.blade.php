                        ...
                        <h5 class="caps">Recent Posts</h5>
                            ...
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    ...
                                    <a href="blog_article.html">{!! $rp->title !!}</a>
                        ...
                        <h5 class="caps">Popular Posts</h5>
                            ...
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    ...
                                    <a href="blog_article.html">{!! $pop_post->title !!}</a>
                    ...
                    <div class="tab_container"> 
                        <div id="tab1" class="tab_content"> 
                            ...
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    <span><a href="{{ route('frontend.articles.show', [$pp->id])}}"><img src="{{url('').'/storage/articles/front_image/'. $pp->front_image}}" alt="" width="100" height="100px" /></a></span>
                                    <a href="blog_article.html">{!! $pp->title !!}</a>
                        ...
                        <div id="tab2" class="tab_content">  
                            <ul class="recent_posts_list">
                                ...
                                <li>
                                    ...
                                    <a href="blog_article.html">{!! $rec_post->title !!}</a>
