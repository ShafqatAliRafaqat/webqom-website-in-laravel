            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                  ...
                  <li><a href="billing_quote_new.html"><i class="fa fa-plus fa-fw"></i><span class="menu-title">Add New Quote</span></a></li>
                    ...
                    <li  @if(isset($page) && $page=='domains') class="active" @endif ><a href="#"><i class="fa fa-globe fa-fw"></i><span class="menu-title">Domains</span><span class="fa arrow"></span></a>
                      <ul class="nav nav-second-level">
                          <li @if(isset($sub_page) && $sub_page=='single_domain') class="active" @endif><a href="{{url('/admin/domain_pricing')}}">Single Domain Pricing List</a></li>
						  <li><a href="bulk_domain_prices_list.html">Bulk Domain Pricing List</a></li>
                          <li><a href="{{url('/admin/domain_pricing/addons')}}">Domain Addons Pricing List</a></li>
                      </ul>
                  	</li> 
