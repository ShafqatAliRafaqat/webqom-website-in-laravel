            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                  ...
                  <li><a href="billing_quote_new.html"><i class="fa fa-plus fa-fw"></i><span class="menu-title">Add New Quote</span></a></li>
                    ...
                    <li  @if(isset($page) && $page=='categories' && \Request::route()->getName() != 'edit_domain_main_page') class="active" @endif><a href="{{url('/admin/categories')}}"><i class="fa fa-cog fa-fw"></i><span class="menu-title">Categories</span></a> </li>
                    ...
                    <li @if(\Request::route()->getName() == 'edit_domain_main_page') class="active" @endif><a href="#"><i class="fa fa-globe fa-fw"></i><span class="menu-title">Domains</span><span class="fa arrow"></span></a>
                      <ul class="nav nav-second-level">
						  ...
						  <li @if(\Request::route()->getName() == 'edit_single_domain_transfer_page') class="active" @endif><a href="{{route('edit_single_domain_transfer_page')}}">Single Domain Search</a></li>
