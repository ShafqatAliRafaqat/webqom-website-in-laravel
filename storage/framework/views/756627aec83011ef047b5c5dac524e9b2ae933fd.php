                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="tab-new-customers" class="tab-pane fade">
                                        	<table id="example1" class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                   <?php if(!empty($new_clients)): ?>
                                                    <?php $count=0; ?>
                                                    <?php $__currentLoopData = $new_clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        <?php if($i->client): ?>
                                                            <?php $count++; ?>
                                                            <tr>
                                                              <td><?php echo e(isset($i->client->client_id) ? $i->client->client_id : ""); ?></td>
                                                              <td><?php echo e($i->client->first_name." ".$i->client->last_name); ?></td>
                                                              <td><a href="mailto:danny@webqom.com"><?php echo e($i->email); ?></a></td>
                                                              <td><?php echo e($i->client->company); ?></td>
                                                              <td><?php echo e(date("d-M-Y",strtotime($i->created_at))); ?></td>
                                                              <td><?php echo e($i->client->account_type); ?></td>
                                                            </tr>
                                                            <?php endif; ?>   
