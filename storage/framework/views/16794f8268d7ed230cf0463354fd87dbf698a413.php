...
<?php $__env->startSection('title','Admin | Articles list'); ?>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="portlet portlet-blue">
        ...
        <div class="portlet-body">
          <form class="form-horizontal" method="GET" action="<?php echo e(route('admin.articles.search')); ?>">
            <div class="col-md-6">
              <div class="form-group">
                <label class="col-md-4 control-label">Article Title </label>
                <div class="col-md-8">
                  <input type="text" class="form-control" name="title_search" value="<?php echo e((isset($inputs['title_search'])) ? $inputs['title_search'] : ''); ?>">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <select name="status_search" class="form-control">
                    <option value="100" <?php echo e((isset($inputs['status_search']) && $inputs['status_search'] == 100) ? "selected" : ''); ?>>- Please select -</option>
                    <option value="1" <?php echo e((isset($inputs['status_search']) && $inputs['status_search'] == 1) ? "selected" : ''); ?>>Active</option>
                    <option value="0" <?php echo e((isset($inputs['status_search']) && $inputs['status_search'] == 0) ? "selected" : ''); ?>>Inactive</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <div class="input-group">
                    <input type="text" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" class="datepicker-default form-control" name="post_date_search" value="<?php echo e((isset($inputs['post_date_search'])) ? $inputs['post_date_search'] : ''); ?>" />
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" class="form-control" name="author_search" value="<?php echo e((isset($inputs['author_search'])) ? $inputs['author_search'] : ''); ?>">
                </div>
              </div>
            </div>
            <!-- end col-md 6 -->
    ...
    <div class="col-lg-12">
      <div class="portlet">
            ...
            <div class="modal-dialog modal-wide-width">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form">
                    <form class="form-horizontal form-add-article" method="POST" action="<?php echo e(route('admin.articles.store')); ?>" enctype="multipart/form-data">
                      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" id="token_create">
                      <div class="form-group">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body" >
                  ...
                  <div class="form-actions" id="modal-delete-selected-footer">
                    <form method="POST" action="<?php echo e(route('admin.articles.destroy.items')); ?>">
          ...
          <div id="modal-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-actions">
                    <form method="POST" action="<?php echo e(route('admin.articles.destroy.bulk.delete')); ?>">
                      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                      <input type="hidden" name="_method" value="DELETE">
                      <div class="col-md-offset-4 col-md-8"> <button type="submit" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                    </form>
        ...
        <div class="portlet-body">
          <?php if(!empty($articles) && !$articles->isEmpty()): ?>
            <div class="form-inline pull-left">
              <div class="form-group">
                ...
                <select name="select" class="form-control" name="per_page" id="per_page">
                  <?php $__currentLoopData = $list_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lg): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <option <?php echo e(($select_page == $lg) ? 'selected="selected"' : ''); ?> value="<?php echo e($lg); ?>"><?php echo e($lg); ?></option>
              ...
              <form id="delete_client">
                <table id="example1" class="table table-hover table-striped">
                  ...
                  <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr>
                      <td><input type="checkbox" name="id[]" value="<?php echo e($article->id); ?>" /></td>
                      <td><?php echo $x; ?></td>
                      <td class="data-title-id-<?php echo e($article->id); ?>"><?php echo $article->title; ?></td>
                      <td><?php echo $article->post_date_month_in_middle; ?></td>
                      <td><?php echo $article->author; ?></td>
                      <td><span class="label label-xs label-<?php echo e(($article->status == 1) ? 'success':'default'); ?>"><?php echo e(($article->status == 1) ? 'Active':'InActive'); ?></span></td>
                      <td>
                        <a href="#" onclick="getArticleById(<?php echo e($article->id); ?>)" data-target="#modal-edit-article" data-toggle="modal" data-hover="tooltip" data-placement="top" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                        <a href="<?php echo e(route('admin.articles.show', [$article->id])); ?>" data-hover="tooltip" data-placement="top" title="View/Reply Comment"><span class="label label-sm label-warning"><i class="fa fa-search"></i></span></a>
                        <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-3" data-toggle="modal" onclick="deleteArticle(<?php echo e($article->id); ?>)"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                      </td>
                    </tr>
                    <?php 
                      $x++;
                ...
                <div class="tool-footer text-right">
                  <p class="pull-left">Showing <?php echo e($articles->firstItem()); ?> to <?php echo e($articles->lastItem()); ?> of <?php echo e($articles->total()); ?> entries</p>
      ...
      <div id="modal-edit-article" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
        <div class="modal-dialog modal-wide-width">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form">
                <form class="form-horizontal form-update-article" method="POST" action="<?php echo e(route('admin.articles.update')); ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-actions">
                <div class="form">
                  <form class="form-horizontal form-delete-author-thumbnail" method="POST" action="<?php echo e(route('admin.articles.update')); ?>">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-actions">
                <form class="form-horizontal form-delete-front-image" method="POST" action="<?php echo e(route('admin.articles.update')); ?>">
                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form">
                <form method="post" action="<?php echo e(route('admin.articles.destroy')); ?>">
                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                  <input type="hidden" name="_method" value="DELETE">
