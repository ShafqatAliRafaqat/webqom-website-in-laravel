...
<?php $__env->startSection('title','Admin | Index- Edit'); ?>
...
<div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="pull-left"> Last updated: <span id="recent_update" class="text-blue"><?php echo e($recent_update); ?></span> </div>
              <div class="clearfix"></div>
              <p></p>
                ...
                <div id="hosting-plans" class="tab-pane fade in active">
                  ...
                  <div class="portlet">
                    <div class="portlet-header">
                      ...
                      <a href="<?php echo e(url('').'/admin/index-plan/create'); ?>" class="btn btn-success">Add New Plan &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                      <div class="btn-group">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-responsive mtl">
                         <form id="delete_client">
                                  ...
                                  <?php if(!empty($indexplans)): ?>
                                      <?php $__currentLoopData = $indexplans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td><span class="label label-xs label-<?php echo e($i->status==1?"success": "danger"); ?>"><?php echo e($i->status==1?"Active": "Inactive"); ?></span></td>
                                            <td><?php echo e($i->name_line1." ".$i->name_line2); ?></td>
                                            <td><?php if($i->price_type=='Recurring'): ?> <span>RM</span> <?php echo e(isset($i->price_annually) ? $i->price_annually : '0'); ?><span>/yr</span><?php endif; ?>
                                                    <?php if($i->price_type=='One Time'): ?> 
                                                    <span>RM</span><?php echo e(isset($i->price_monthly) ? $i->price_monthly : '0'); ?> <span>/mo</span>
                                                    <?php endif; ?>
                                                    <?php if($i->price_type=='Free'): ?> 
                                                    <span>Free</span></p>
                                                    <?php endif; ?></td>
                                            <td>-</td>
                                            <td><input type="text" id="<?php echo e($i->id); ?>" class="form-control" value="<?php echo e($i->sort_order); ?>"></td>
                                            <td class="alicent"><a href="<?php echo e(url('').'/admin/index-plan/'.$i->id.'/edit'); ?>" data-hover="tooltip" data-placement="top" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                               
                                                <!--Modal delete plan start-->
                                                <div id="modal-delete-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade alileft">
                                                  <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      <div class="modal-header">
                                                        <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                                      ...
                                                      <div class="modal-body">
                                                        <p><strong>#<?php echo e($i->id); ?>: <?php echo e($i->name_line1." ".$i->name_line2); ?></strong></p>
                                                        <div class="form-actions">
                                                          
                                                          <input type="hidden" value="<?php echo e($i->id); ?>" name="id">
                                                          
                                                          <div class="col-md-offset-4 col-md-8"> 
                                                          <button type="button" id="delete_single_btn" onclick="delete_single(<?php echo e($i->id); ?>)" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i>
                            ...
                            <span>Showing  <?php echo e($indexplans->firstItem()); ?> to <?php echo e($indexplans->lastItem()); ?> of <?php echo e($indexplans->total()); ?></span>
                      <span class="pull-right"><?php echo e($indexplans->links()); ?></span>
              ...
              <div class="table-responsive mtl">
                <table class="table table-hover table-striped">
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td><span class="label label-xs label-<?php echo e($general_features[0]['heading_status']?'success':'danger'); ?>"><?php echo e($general_features[0]['heading_status']?'Active':'Inactive'); ?></span></td>
                              ...
                              <div class="modal-body">
                                <div class="form">
                                  <form id="frm_general_features_heading" class="form-horizontal">
                                    ...
                                    <input type="hidden" name="page" class="form-control" value="<?php echo e($page_name); ?>"> 
                                    <div class="form-group">
                                      <label class="col-md-3 control-label">Status</label>
                                      <div class="col-md-6">
                                        <div data-on="success" data-off="primary" class="make-switch">
                                          <input name="status" type="checkbox" <?php if($general_features[0]['heading_status']==1): ?> checked="checked" <?php endif; ?>/>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                        <input type="text" name="heading"  class="form-control"  value="<?php echo e($general_features[0]['heading']); ?>">
                       ...
                       <form id="frm_general_features" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="help-block">Please refer here for complete <a href="<?php echo e(url('/admin/icons')); ?>" target="_blank">icon options.</a>
                  ...
                  <table class="table table-hover table-striped">
                    ...
                    <tbody>
                      <form id="delete_general_features">
                        ...
                        <?php $count_gf++; ?>
                        <tr>
                          <td><input type="checkbox" class="gf_checkbox" value="<?php echo e($i->id); ?>" name="id_gf[]"></td>
                          <td><?php echo e($count_gf); ?></td>
                          <td><span class="label label-xs label-<?php echo e($i->status?'success':'danger'); ?>"><?php echo e($i->status?'Active':'Inactive'); ?></span></td>
                          <td><?php echo e($i->title); ?></td>
                          <td><a href="javascript:void" onclick="edit_general_feature(<?php echo e($i->id); ?>)" data-hover="tooltip" data-placement="top"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-general-feature-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>

                            <!--Modal delete start-->
                            <div id="modal-delete-general-feature-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                  ...
                                  <div class="modal-body">
                                    <p><strong>#<?php echo e($i->id); ?>:</strong><?php echo e($i->title); ?></p>
                                    <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8"> <button type="button" onclick="delete_gf_single(<?php echo e($i->id); ?>)" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <form id="delete_selected_videos">
                          ...
                          <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <?php $count_videos=0; ?>
                                    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                              <tr>
                              <?php $count_videos++  ?>
                                <td><input type="checkbox" name="id_video[]" value="<?php echo e($i->id); ?>" class="video_checkbox"></td>
                                <td><?php echo e($count_videos); ?></td>
                                <td><span class="label label-xs label-<?php echo e($i->status?'success':'danger'); ?>"><?php echo e($i->status?'Active':'Inactive'); ?></span></td>
                                <td><?php echo e($i->heading); ?></td>
                                <td><?php echo e($i->video_title); ?></td>
                                <td><a href="javascript:void" onclick="add_video(<?php echo e($i->id); ?>)"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-faq-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                  <!--Modal delete faq start-->
                                  <div id="modal-delete-faq-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                              ...
                                              <div class="modal-body">
                                                <p><strong>#<?php echo e($i->id); ?>:</strong> <?php echo e($i->heading); ?></p>
                                                <div class="form-actions">
                                                  <div class="col-md-offset-4 col-md-8"> <a href="javascript:void" id="delete_single_video_btn" onclick="delete_single_video(<?php echo e($i->id); ?>)" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                ...
                <table class="table table-hover table-striped">
                  ...
                  <?php if(count($offer_services)>0): ?>
                    <tr>
                      ...
                      <td><span class="label label-xs label-<?php echo e($offer_services[0]['heading_status']==1?'success':'danger'); ?>"><?php echo e($offer_services[0]['heading_status']?'Active':'Inactive'); ?></span></td>
                      <td><?php echo e(isset($offer_services[0]['heading']) ? $offer_services[0]['heading'] : "No heading found"); ?></td>
                                ...
                                <div class="form">
                                  <form id="frm_offer_services_heading" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                                  <div data-on="success" data-off="primary" class="make-switch">
                                                    <input name="status" type="checkbox" <?php if($offer_services[0]['heading_status']==1): ?> checked="checked" <?php endif; ?>/>
                                                  </div>
                                                </div>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                        <input type="text" name="heading"  class="form-control"  value="<?php echo e($offer_services[0]['heading']); ?>">
                      ...
                      <div id="modal-add-service" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                        <div class="modal-dialog modal-wide-width">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="form">
                                <form id="frm_services" class="form-horizontal"  method="post" enctype="multipart/form-data" >
                                <?php echo e(csrf_field()); ?>
                                ...
                                <input type="hidden" name="id" >
								  ...
								  <div class="form-group">
                                    <label class="col-md-3 control-label">Heading <span class="text-red">*</span></label>
                                    <div class="col-md-6">
                                      <input type="text" name="header" class="form-control" placeholder="eg. Register a domain with us and a 14 day free trial to Email88.">
                                      <p class="red_error" id="err_off_services_header"></p>
                                    </div>
                                  </div>
								  <div class="form-group">
                                    <label class="col-md-3 control-label">Side Image <span class="text-red">*</span></label>
                                    <div class="col-md-6">
									  <div class="old-img" ></div>
                                      <div class="xs-margin"></div>
									  <input name="side_image" id="exampleInputFile2" type="file"/>
									  <p class="red_error" id="err_off_services_side_image"></p>
									</div>
                                  </div>
								  <div class="form-group">
                                    <label class="col-md-3 control-label">Link <span class="text-red">*</span></label>
                                    <div class="col-md-6">
                                      <input type="text" name="link" class="form-control" placeholder="eg. /hosting">
                                      <p class="red_error" id="err_off_services_link"></p>
                                    </div>
                                  </div>
                          ...
                          <table class="table table-hover table-striped">
                            ...
                            <tbody>
                              <?php if(count($offer_services)>0): ?>
                                ...
                                <?php $__currentLoopData = $offer_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                   <tr>
                                <td><input type="checkbox" name="id_os[]" class="os_checkbox" value="<?php echo e($i->id); ?>"></td>
                                <td><?php echo e($offer_services_count); ?></td>
                                <td><span class="label label-xs label-<?php echo e($i->status?'success':'danger'); ?>"><?php echo e($i->status?'Active':'Inactive'); ?></span></td>
                                <td><?php echo e($i->title); ?></td>
                                <td><input type="text" name="update_so_of[<?php echo e($i->id); ?>]" class="form-control" value="<?php echo e($i->sort_order); ?>"></td>
                                <td><a href="javascript:void" onclick="store_offer_service(<?php echo e($i->id); ?>)" data-hover="tooltip" data-placement="top" data-target="#modal-edit-service" data-toggle="modal" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-service-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                 
                                  <!--Modal delete service 1 start-->
                                  <div id="modal-delete-service-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                              ...
                                              <div class="modal-body">
                                                <p><strong>#<?php echo e($i->id); ?>:</strong> <?php echo e($i->title); ?></p>
                                                <div class="form-actions">
                                                  <div class="col-md-offset-4 col-md-8"> <a href="javascript:void" onclick="delete_offer_services(<?php echo e($i->id); ?>)" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="javascript:void"  data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                      ...
                      <div class="table-responsive mtl">
                        <table class="table table-hover table-striped">
                          ...
                          <tbody>
                            <tr>
                              <td>1</td>
                              <td><span class="label label-xs label-<?php echo e($testimonials[0]['heading_status']?'success':'danger'); ?>"><?php echo e($testimonials[0]['heading_status']?'Active':'Inactive'); ?></span></td>
                      <td><?php echo e($testimonials[0]['heading']); ?></td>
                                          ...
                                          <div class="form">
                                            ...
                                            <?php echo e(csrf_field()); ?>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <div data-on="success" data-off="primary" class="make-switch">
                                                    <input name="status" type="checkbox" <?php if($testimonials[0]['heading_status']==1): ?> checked="checked" <?php endif; ?>/>
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="form-group">
                                                <label class="col-md-3 control-label">Heading <span class="text-red">*</span> </label>
                                                <div class="col-md-6">
                                                   <input name="heading" type="text" class="form-control" value="<?php echo e($testimonials[0]['heading']); ?>"> 
                  ...
                  <div class="portlet">
                    ...
                    <tbody>
                      <form id="delete_testimonial">
                        ...
                        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <?php $count_test++; ?>
                        <tr>
                          <td><input type="checkbox" class="testimonials_checkall" value="<?php echo e($i->id); ?>" name="id_testimonial[]"></td>
                          <td><?php echo e($count_test); ?></td>
                          <td><span class="label label-xs label-<?php echo e($i->status?'success':'danger'); ?>"><?php echo e($i->status?'Active':'Inactive'); ?></span></td>
                          <td><?php echo e($i->client_name); ?></td>
                          <td><?php echo e($i->company); ?></td>
                          
                          <td><a href="javascript:void" onclick="save_testimonial(<?php echo e($i->id); ?>)" data-hover="tooltip" data-placement="top"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-general-feature-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                            ...
                            <div id="modal-delete-general-feature-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p><strong>#<?php echo e($i->id); ?>:</strong><?php echo e($i->client_name); ?></p><br>
                                    <span><strong>Company</strong><?php echo e($i->company); ?></span>
                                    <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8"> <button type="button" onclick="delete_single_testimonial(<?php echo e($i->id); ?>)" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                    </div>
                                  </div>
                                </div>
                              </div>
          ...
          <div class="form">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name="page" type="hidden" class="form-control" value="<?php echo e($page_name); ?>">
                <input type="text" name="title"   class="form-control" placeholder="eg. Ultra-Fast Platform ">
   ...
   <script type="text/javascript">
       function delete_single(id) {
           if (id>0) {
            ...
            $.ajax({
                url: "<?php echo e(url('').'/admin/index-plan/delete'); ?>",
                type: 'POST',
                data: {'id_index': id,'_token':'<?php echo e(csrf_token()); ?>'},
            })
            .done(function() {
                location.reload();
            })
...
function delete_single_video(id) {
           if (id>0) {
            ...
            $.ajax({
                url: "<?php echo e(url('').'/admin/delete_video'); ?>",
                type: 'POST',
                data: {'id_video': id,'_token':'<?php echo e(csrf_token()); ?>'},
            })
            .done(function() {
                window.location.href=base_url+"/admin/index-plan?tab=video";
            })
...
function store_offer_service(id) {
  ...
  if (id>0) {
    ...
    .done(function(response) {
	  ...
	  $('#frm_services input[name=header]').val(response.header);
	  $('#frm_services input[name=link]').val(response.link);
	  $('#frm_services .old-img').html('<img src="'+base_url+'/storage/index-plan/service-side-images/'+response.image+'" style="width:100%" />');
    ...
    $('#frm_services input[name=title]').val("");
	  ...
	  $('#frm_services input[name=header]').val("");
	  $('#frm_services input[name=link]').val("");
	  $('#frm_services .old-img').html('');
...
function open_modal_delete_selected_testimonials() {
 ...
 function  save_testimonial(id) {
  $('.make-switch').bootstrapSwitch('setState', true); // true || false
    ...
    $("#modal-add-testimonial-heading").html("Add New Testimonial");
    if (id>0) {
      $("#modal-add-testimonial-heading").html("Edit Testimonial");
