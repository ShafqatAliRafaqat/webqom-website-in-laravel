<?php $__env->startSection('title','My Account | - Webqom Technologies'); ?>
<?php $__env->startSection('page_header','My Account'); ?>
<?php $__env->startSection('breadcrumbs','<a href="./dashboard">Dashboard</a> / My Account / Update Account Details'); ?>
...
<div class="content_fullwidth">
    ...
    <div class="container" id="scroll_here">
    	...
    	<?php echo $__env->make("frontend.client_dashboard_sidebar", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class="tabs-content" >
            ...
            <div id="tab-1" class="tabs-panel">
                ...
                <div  class="one_third_less">
                    <h4>Account Type:</h4>
                    <div class="text-16px light sitecolor"><?php echo e($user->client->account_type); ?></div>
                    
                </div>
                
                <div class="one_third_less">
                	<h4>Client ID:</h4>
                    <div class="text-16px light sitecolor"><?php echo e($user->client->client_id); ?></div>
                </div>
                ...
                <div style="display:none" id="msg_error" class="alert alert-danger alert-dismissable">
                    ...
                    <form  type="POST" id="frm_update_info" ">
                        ...
                        <div class="one_half_less">
                            ...
                            <input type="text" name="first_name" id="firstname" value="<?php echo e($user->client->first_name); ?>">
                            <div id="err_fname" class="red"></div>
                            <label><b>Last Name</b> <em>*</em></label>
                            <input type="text" name="last_name" id="lastname" value="<?php echo e($user->client->last_name); ?>">
                            <div id="err_lname" class="red"></div>
                            <label><b>Company</b> <em>(* Mandatory for Business Account)</em></label>
                            <input type="text" name="company" id="company" value="<?php echo e($user->client->company); ?>">   
                            <div id="err_company" class="red"></div>
                            <label><b>Email Address</b> <em>*</em></label>
                            <input type="text" name="email" id="name" placeholder="mail@yourdomain.com" value="<?php echo e($user->email); ?>">
                            <div id="err_email" class="red"></div>
                            <label><b>Phone</b> <em>*</em></label>
                            <input type="text" name="phone_number" id="phone" value="<?php echo e($user->client->phone_number); ?>">
                            <div id="err_phone" class="red"></div>
                            <label><b>Mobile Phone</b> <em>*</em></label>
                            <input type="text" name="mobile_phone_number" id="mobile_phone" value="<?php echo e($user->client->mobile_number); ?>">  
                        ...
                        <div class="one_half_less last">
                            ...
                            <input type="text" name="address_1" id="address" value="<?php echo e($user->client->address1); ?>">
                            <div id="err_address1" class="red"></div>
                            <label><b>Address 2 </b></label>
                            <input type="text" name="address_2" value="<?php echo e($user->client->address2); ?>" id="<?php echo e($user->client->address2); ?>"> 
                            ...
                            <select name="country" class="form-control countries select_height" id="country">
                                    ...
                                    <option value="<?php echo e($country->id); ?>" <?php if($user->client->country_id==$country->id): ?> selected <?php endif; ?>><?php echo e($country->name); ?></option>
                            ...
                            <input type="text" name="postal_code" id="postal_code" value="<?php echo e($user->client->postal_code); ?>"> 
                        ...
                        <div id="subscribe_yes" <?php if($user->client->news_letter!=0): ?> hidden <?php endif; ?>   >
        ...
        function get_state(){
            var country_id=$( "#country option:selected" ).val();
                    ...
                    .done(function(response) {
                        var state_selected="";
                        for (var i=0; i < response.length; i++) {
                            if (response[i].id=='<?php echo e($user->client->state_id); ?>') {
                                    $("#state").append(
                                        $("<option>" , {
                                            text: response[i].name,
                                            value:  response[i].id,
                        ...
                        .done(function(response) {
                            var city_selected="";
                            for (var i=0; i < response.length; i++) {
                                if (response[i].id=='<?php echo e($user->client->city_id); ?>') {
                                    $("#city").append(
                                        $("<option>" , {
                                            text: response[i].name,
                                            value:  response[i].id,
