<?php $__env->startSection('title','Login | - Webqom Technologies'); ?>
<?php $__env->startSection('page_header','Login'); ?>
<?php $__env->startSection('breadcrumbs','Login'); ?>
...
<div class="container">
    ...
    <div class="one_half_less">
     ...
     <div class="red"  id="loginErrors"></div>
            ...
            <div class="red" id="loginPasswordErrors"></div>
                ...
                <a href="<?php echo e(url('/reset_password')); ?>">Forgot your password?</a>
                <div class="clearfix"></div>
    ...
    <div class="one_half_less last">
        ...
        <div class="clearfix"></div>
        <div class="margin_top3"></div>
        <a href="<?php echo e(url('/register')); ?>" class="but_medium1 caps">Register</a>
    </div><!-- end section -->
