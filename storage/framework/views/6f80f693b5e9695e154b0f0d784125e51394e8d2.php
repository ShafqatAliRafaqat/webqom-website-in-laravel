...
<div id="modal-add-new-price-<?php echo e($type); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
<div class="modal-dialog modal-wide-width">
	...
	<div class="modal-body">
		<div class="form">
		<form class="form-horizontal" method="post" action="<?php echo e(route('domain_pricing_list.store')); ?>">
			...
			<div class="form-group">
			 ...
			 <div class="col-md-6">
				<div class="xss-margin"></div>
				<div class="checkbox-list">
					<label><input type="checkbox" data-toggler data-toggle=".toggle-create-<?php echo e($type); ?>">&nbsp; Select all</label>
					<label><input class="toggle-create-<?php echo e($type); ?>" name="addons[]" type="checkbox" value="DNS Managment">&nbsp; DNS Management</label>
					<label><input class="toggle-create-<?php echo e($type); ?>" name="addons[]" type="checkbox" value="Email Forwarding">&nbsp; Email Forwarding</label>
					<label><input class="toggle-create-<?php echo e($type); ?>" name="addons[]" type="checkbox" value="ID Protection">&nbsp; ID Protection</label>
				 </div>
			 </div>
			</div>
			...
			<table class="table table-hover table-striped">
				...
				<tr>
					<td>Sale Price</td>
					<?php for($i = 1; $i <= 10; $i++): ?>
						<td><input type="text" required pattern="^(\d+)(\.\d\d|)$" title="This should be number with only two digits after dot" name="sale_price[<?php echo e($i); ?>]" class="form-control text-red"></td>
					<?php endfor; ?>
				 </tr>
				 <tr>
					<td>List Price</td>
					<?php for($i = 1; $i <= 10; $i++): ?>
						<td><input type="text" required pattern="^(\d+)(\.\d\d|)$" title="This should be number with only two digits after dot" name="list_price[<?php echo e($i); ?>]" class="form-control"></td>
					<?php endfor; ?>
				 </tr>
				 </tbody>
				 <tfoot>
