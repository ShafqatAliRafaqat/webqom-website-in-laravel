...
<head>
    ...
    <link href="<?php echo e(url('').'/resources/assets/admin/'); ?>images/icons/favicon.ico" rel="shortcut icon">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-ui-1.10.3.custom/css/ui-lightness/jquery-ui-1.10.3.custom.css">
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/font-awesome/css/font-awesome.min.css">
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap/css/bootstrap.min.css">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/animate.css/animate.css">
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-pace/pace.css">
    <!--Loading style-->
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>css/style.css">
    <!--<link type="text/css" rel="stylesheet" href="css/style.css">-->
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>css/style-mango.css" id="theme-style">
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>css/vendors.css">
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>css/themes/grey.css" id="color-style">
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>css/style-responsive.css">

    <!-- updated on 10/25/2018 -->
    <link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/metisMenu/metisMenu.min.css">
</head>
...
if($user->profile_pic!=''){
    $pic=$user->profile_pic;
        ...
        <div id="wrapper">
            ...
            <nav id="topbar" role="navigation" style="margin-bottom: 0;" class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    ...
                    <a id="logo" href="<?php echo e(url('/')); ?>" target="_blank" class="navbar-brand"><img src="<?php echo e(url('').'/resources/assets/admin/'); ?>images/logo_web88.png"></a> </div>
                <div class="topbar-main">
                    <a id="logo" href="#" class="navbar-brand"><img src="<?php echo e(url('').'/resources/assets/admin/'); ?>images/logo.jpg"></a>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="dropdown"><a data-toggle="dropdown" href="#" id="profile_pic_dd" class="dropdown-toggle"><img src="<?php echo e($pic); ?>" alt="" class="img-responsive img-circle"/>&nbsp;
                                    ...
                                    <div class="navbar-content">
                                        <div class="row">
                                            <div class="col-md-5 col-xs-5">
                                                <img src="<?php echo e($pic); ?>" id="profile_pic_ee" alt="" class="img-responsive img-circle"/>
                                        ...
                                        <div class="navbar-footer-content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-xs-6">
                                                    <a href="<?php echo e(url('web88/admin/logout')); ?>"  class="btn btn-default btn-sm pull-right">Sign Out</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <form id="frm_change_pic">
                                            ...
                                            <div class="text-15px margin-top-10px">
                                              ...
                                              src="<?php echo e($pic); ?>" alt="Avatar" class="img-responsive"><br />
            ...
            <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                        ...
                        <li <?php if(isset($page) && $page=='dashboard' ): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('/web88/admin')); ?>"><i class="fa fa-laptop fa-fw"></i><span class="menu-title">Dashboard</span></a></li>
                        <li class="sidebar-heading"><h4>Clients</h4>
                        </li>
                        <li <?php if(isset($page) && $page=='clients' ): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('/clients/listing')); ?>"><i class="fa fa-user fa-fw"></i><span class="menu-title">Clients Listing</span></a></li>
                        <li class="sidebar-heading"><h4>Billing</h4>
                        </li>
                        ...
                        <li class="sidebar-heading"><h4>Orders</h4>
                        </li>
                        ...
                        <li class="sidebar-heading"><h4>Services</h4>
                        </li>
                        <li <?php if(isset($page) && $page=='categories' && \Request::route()->getName() != 'edit_domain_main_page' && \Request::route()->getName() != 'edit_single_domain_transfer_page'): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('/admin/categories')); ?>"><i class="fa fa-cog fa-fw"></i><span class="menu-title">Categories</span></a> </li>
                        <li <?php if(isset($page) && $page=='domains' ): ?> class="active mm-active" <?php endif; ?>>
                            <a href="#" <?php if(isset($page) && $page=='domains' ): ?> aria-expanded="true" <?php endif; ?>><i class="fa fa-globe fa-fw"></i>
                            <span class="menu-title">Domains</span>
                            <span class="fa arrow"></span>
                        </a>
                            <ul class="nav nav-second-level">
                                <li <?php if(isset($sub_page) && $sub_page=='single_domain' ): ?> class="active" <?php endif; ?>>
                                    <a href="<?php echo e(url('/admin/domain_pricing')); ?>">Single Domain Pricing List</a>
                                </li>
                                <li <?php if(isset($sub_page) && $sub_page=='bulk_domain' ): ?> class="active" <?php endif; ?>>
                                    <a href="<?php echo e(url('/web88/admin/bulk_domain')); ?>">Bulk Domain Pricing List</a>
                                </li>
                                <li <?php if(isset($sub_page) && $sub_page=='domain_addons' ): ?> class="active" <?php endif; ?>>
                                    <a href="<?php echo e(url('/admin/domain_pricing/addons')); ?>">Domain Addons Pricing List</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li <?php if(isset($page) && $page=='enquiry' ): ?> class="active" <?php endif; ?>><a   href="<?php echo e(route('enquires-list')); ?>"><i class="fa fa-info-circle fa-fw"></i><span class="menu-title">Services Enquiry Listing</span></a></li>
                        <li class="sidebar-heading"><h4>Promotions</h4>
                        </li>
                        ...
                        <li class="sidebar-heading"><h4>Support</h4>
                        </li>
                        ...
                        <li class="sidebar-heading"><h4>Banners</h4>
                        </li>
                        <li <?php if(isset($page) && $page=='banners'): ?> class="active mm-active" <?php endif; ?>><a href="<?php echo e(route('admin.banners.index')); ?>"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Index Banners</span></a></li>
                        <li class="sidebar-heading"><h4>CMS Pages</h4>
                        </li>
                        <li <?php if(isset($page) && $page=='blog' ): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('admin.articles.index')); ?>"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Blog</span></a></li>
                        <li <?php if(\Request::route()->getName() == 'edit_domain_main_page' || \Request::route()->getName() == 'edit_single_domain_transfer_page'): ?> class="active mm-active" <?php endif; ?>><a href="#"  <?php if(\Request::route()->getName() == 'edit_domain_main_page' || \Request::route()->getName() == 'edit_single_domain_transfer_page'): ?> aria-expanded="true" <?php endif; ?>><i class="fa fa-globe fa-fw"></i><span class="menu-title">Domains</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li <?php if(\Request::route()->getName() == 'edit_domain_main_page'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('edit_domain_main_page')); ?>">Domains Main Page</a></li>
                                <li><a href="#">Single Domain Search</a></li>
                                <li><a href="bulk_domain_search_edit.html">Bulk Domain Search</a></li>
                                <li <?php if(\Request::route()->getName() == 'edit_single_domain_transfer_page'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('edit_single_domain_transfer_page')); ?>">Single Domain Transfer</a></li>
                                <li><a href="bulk_domain_transfer_edit.html">Bulk Domain Transfer</a></li>
                            </ul>
                        </li>
                        <li class="sidebar-heading"><h4>Global Setup</h4>
                        </li>
            ...
            <div id="page-wrapper">
                ...
                <div class="page-header-breadcrumb">
                    <div class="page-heading hidden-xs">
                        <h1 class="page-title"><?php echo $__env->yieldContent('page_header'); ?></h1>
                    </div>
                    <ol class="breadcrumb page-breadcrumb">
                        <li><i class="fa fa-home"></i>&nbsp;<a href="<?php echo e(url('/web88/admin')); ?>">Dashboard</a>&nbsp;</li>
                        ...
                        <li>
                            ...
                            <?php if($i['url']==false): ?><span style="text-transform: capitalize;"><?php echo e($i['name']); ?></span><?php endif; ?>
                        </li>
                ...
                <div class="page-footer" style="height: 62px">
                    <div class="copyright"><span class="text-15px">2016 © <a href="http://www.webqom.com" target="_blank">Webqom Technologies Sdn Bhd.</a> Any queries, please contact <a href="mailto:support@webqom.com">Webqom Support</a>.</span>
                        <div class="pull-right"><img src="<?php echo e(url('').'/resources/assets/admin/'); ?>images/logo_webqom.png" alt="Webqom Technologies"></div>
                        </div>
                    </div>
                    <!--END FOOTER-->
                </div>
        ...
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/jquery.js"></script>
        <!-- <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/jquery-migrate-1.2.1.min.js"></script> -->
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/jquery-ui.js"></script>
        <!--loading bootstrap js-->
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap/js/bootstrap.min.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-hover-dropdown/bootstrap-hover-dropdown.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/html5shiv.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/respond.min.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/metisMenu/jquery.metisMenu.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/slimScroll/jquery.slimscroll.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-cookie/jquery.cookie.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/jquery.menu.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-pace/pace.min.js"></script>
        <!--LOADING SCRIPTS FOR PAGE-->
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-jvectormap/jquery-jvectormap-world-mill-en.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-jvectormap/gdp-data.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-knob/jquery.knob.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-animateNumber/jquery.animateNumber.min.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.categories.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.pie.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.tooltip.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.resize.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.fillbetween.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.stack.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/flot-chart/jquery.flot.spline.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/skycons/skycons.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-news-ticker/jquery.news-ticker.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/index.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-daterangepicker/daterangepicker.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/moment/moment.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-clockface/js/clockface.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-colorpicker/js/bootstrap-colorpicker.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/bootstrap-switch/js/bootstrap-switch.min.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>vendors/jquery-maskedinput/jquery-maskedinput.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/form-components.js"></script>
        <!--CORE JAVASCRIPT-->
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/main.js"></script>
        <script src="<?php echo e(url('').'/resources/assets/admin/'); ?>js/holder.js"></script>
        ...
        $(document).on('submit', '#frm_change_pic', function(event) {
            ...
            form_data.append("id", '<?php echo e($user->id); ?>')
