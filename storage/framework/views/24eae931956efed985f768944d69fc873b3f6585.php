...
<?php $__env->startSection('title','Admin | Bulk Domain Pricing - Listing'); ?>
        ...
        <div class="portlet-body">
              ...
              <table id="clients_list" class="table table-hover table-striped">
                ...
                <tbody>
                  ...
                  <tr id="clienttbl_row_<?php echo e($i->id); ?>">
                    ...
                    <td>
                      <a href="#" data-hover="tooltip" data-placement="top" title="Edit" data-target="#modal-edit-form-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                      
                      <!-- <a href="<?php echo e(route('domain_pricing_list.show',$i->id)); ?>" data-hover="tooltip" data-placement="top" title="Add Pricing"><span class="label label-sm label-warning"><i class="fa fa-plus"></i></span></a> -->
                      <a href="#" data-target="#modal-add-new-price-<?php echo e($i->id); ?>"  data-toggle="modal" data-hover="tooltip" data-placement="top" title="Add Pricing"><span class="label label-sm label-warning"><i class="fa fa-plus"></i></span></a>
                      
                      <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                    </td>
                  </tr>
                  <?php $count++;?>
          ...
          <?php $__currentLoopData = $domain_pricing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
              <!--Modal Add New Pricing start-->
                  <div id="modal-add-new-price-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                      <div class="modal-dialog modal-wide-width">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                              ...
                              <div class="modal-body">
                                  <div class="form">
                                      <form class="form-horizontal" name="bulk_doman_form2" id="bulk_doman_form2<?php echo e($i->id); ?>" enctype="multipart/form-data" method="POST" action="/admin/bulk_domain/add">
                                          <?php echo e(csrf_field()); ?>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-6">
                                                  <div data-on="success" data-off="primary" class="make-switch">
                                                      <input name="status" type="checkbox" <?php echo e((!empty($listing) && !empty($listing->status))?'checked="checked"':''); ?> value="1"/>
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-6">
                                                  <input type="text" name="tld" class="form-control" placeholder="eg .com" value="<?php echo e((!empty($listing) && !empty($listing->tld))?$listing->tld:''); ?>">
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-md-6">
                                                  ...
                                                  <div class="checkbox-list">
                                                      <label><input type="radio" value="1" <?php echo e((!empty($listing) && !empty($listing->epp_code == 1))?'checked="checked"':''); ?> name="epp_code"/>&nbsp; Enabled</label>
                                                      <label><input type="radio" value="0" <?php echo e((!empty($listing) && !empty($listing->epp_code == 2))?'checked="checked"':''); ?> name="epp_code"/>&nbsp; Disabled</label>
                                                  </div>
                                              </div>
                                          </div>
                                              ...
                                              <div class="col-md-6">
                                                  ...
                                                  <div class="checkbox-list" name="list-select-all">
                                                      ...
                                                      <?php 
                                                       ...
                                                       ?>
                                                      <?php $__currentLoopData = $domain_addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain_addon): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                          <label><input type="checkbox" name="addons[]" value="<?php echo e($domain_addon->id); ?>" <?php echo e((!empty($listing) && in_array($domain_addon->id, $selected_addons))?'checked="checked"':''); ?>/>&nbsp;<?php echo e($domain_addon->title); ?> <?php echo e($domain_addon->price); ?></label>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                      <input type="hidden" name="domain_pricing_id" value="<?php echo e($i->id); ?>">
                                                  </div>
                                              </div>
                                          </div>
                                          ...
                                          <div class="table-responsive mtl">
                                              <table class="table table-hover table-striped">
                                                  ...
                                                  <?php $__currentLoopData = $RMSALE; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$domain): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                      ...
                                                      ?>
                                                      <tr>
                                                          <td>Sale Price (<?php echo e($domain['duration']); ?>)</td>
                                                          <td><input type="text" name="year_sale_1<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_1 ))?$pricing->year_sale_1:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_2<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_2 ))?$pricing->year_sale_2:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_3<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_3 ))?$pricing->year_sale_3:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_4<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_4 ))?$pricing->year_sale_4:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_5<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_5 ))?$pricing->year_sale_5:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_6<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_6 ))?$pricing->year_sale_6:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_7<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_7 ))?$pricing->year_sale_7:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_8<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_8 ))?$pricing->year_sale_8:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_9<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_9 ))?$pricing->year_sale_9:''); ?>" class="form-control text-red"></td>
                                                          <td><input type="text" name="year_sale_10<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_sale_10 ))?$pricing->year_sale_10:''); ?>" class="form-control text-red"></td>
                                                      </tr>
                                                      <tr>
                                                          <td>List Price (<?php echo e($RMLIST[$index]['duration']); ?>)</td>
                                                          <td><input type="text" name="year_list_1<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_1 ))?$pricing->year_list_1:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_2<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_2 ))?$pricing->year_list_2:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_3<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_3 ))?$pricing->year_list_3:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_4<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_4 ))?$pricing->year_list_4:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_5<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_5 ))?$pricing->year_list_5:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_6<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_6 ))?$pricing->year_list_6:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_7<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_7 ))?$pricing->year_list_7:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_8<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_8 ))?$pricing->year_list_8:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_9<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_9 ))?$pricing->year_list_9:''); ?>" class="form-control"></td>
                                                          <td><input type="text" name="year_list_10<?php echo e($index); ?>" value="<?php echo e((!empty($pricing) && !empty($pricing->year_list_10 ))?$pricing->year_list_10:''); ?>" class="form-control"></td>
                                                      </tr>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                  </tbody>
                                                  <tfoot>
                                          ...
                                          <div class="form-actions">
                                              <div class="col-md-offset-5 col-md-8"> <a href="javascript:void" onclick="add_sub_cat('bulk_doman_form2<?php echo e($i->id); ?>')" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                          </div>
                                      </form>
                                  </div>
                              </div>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <div class="form-actions">
                                      <div class="col-md-offset-4 col-md-8"> <button type="button" class="btn btn-red delete_single_button" onclick="delete_single(<?php echo e($i->id); ?>)">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                  </div>
                              </div>
                          </div>
                      </div>
