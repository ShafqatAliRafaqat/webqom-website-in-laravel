                ...
                <div class="portlet-body">
                  <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                      <form action=" <?php echo e(asset(route('enquires-create'))); ?>" method="POST">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="service"  name="service" value="<?php echo e(isset($enquiry->service) ? $enquiry->service : ''); ?>">
                          </div>
                          <div class="form-group">
                              <label for="name">Name:</label>
                              <input type="text" class="form-control" id="name"  name="name" value="<?php echo e(isset($enquiry->name) ? $enquiry->name : ''); ?>">
                          </div>
                          <div class="form-group">
                              <label for="email">Email:</label>
                              <input type="email" class="form-control" id="email"  name="email" value="<?php echo e(isset($enquiry->email) ? $enquiry->email : ''); ?>">
                          </div>
                          <div class="form-group">
                              <label for="company">Company:</label>
                              <input type="text" class="form-control" id="company"  name="company" value="<?php echo e(isset($enquiry->company) ? $enquiry->company : ''); ?>">
                          </div>
                          <div class="form-group">
                              <label for="phone">Phone:</label>
                              <input type="text" class="form-control" id="phone"  name="phone" value="<?php echo e(isset($enquiry->phone) ? $enquiry->phone : ''); ?>">
                          </div>
                          <div class="form-group">
                              <label for="website">Website:</label>
                              <input type="text" class="form-control" id="website"  name="website" value="<?php echo e(isset($enquiry->website) ? $enquiry->website : ''); ?>">
                          </div>
                          <div class="form-group">
                              <label for="message">Message:</label>
                              <textarea name="message" class="form-control" id="message"  name="message"><?php echo e(isset($enquiry->message) ? $enquiry->message : ''); ?></textarea>
                          </div>
