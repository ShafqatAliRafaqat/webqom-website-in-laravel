...
<?php $__env->startSection('title','Admin | '.$page_name.'- New'); ?>
...
<div class="row">
<div class="col-lg-12">
<h2><?php echo e($page_name); ?> <i class="fa fa-angle-right"></i> Add New</h2>
...
<?php endif; ?>
  ...
  <div class="clearfix"></div>
      ...
      <div class="pull-left"> Last updated: <span id="updated_date" class="text-blue">11 jan,2017</span> </div>
      <div class="clearfix"></div>
      <p></p>
<ul id="myTab" class="nav nav-tabs">
  <li class="active"><a href="#general-pricing" data-toggle="tab">General/Pricing</a></li>
  <li><a href="javascript:void" title="This feature will be enable after saving plan"  data-hover="tooltip" data-placement="top"  >Plan Feature Details</a></li>
  <li><a href="javascript:void" title="This feature will be enable after saving plan"  data-hover="tooltip" data-placement="top" >Free Domain</a></li>
</ul>
<div  class="tab-content">

  <div id="general-pricing" class="tab-pane fade in active">
    <form id="frm_genrel" class="form-horizontal" action="<?php echo e(url('/admin/services/new_hosting_plan')); ?>" method="POST" enctype="multipart/form-data">
      <div class="portlet">
                  ...
                  <div class="col-md-6">
                    ...
                    <p class="red_error" id="status"></p>
                                      ...
                                      <!--<div class="form-group">
                                        ...
                                        <input type="hidden" name="is_ssl_page" value="<?php echo e($is_ssl_page); ?>">
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <select name="category" class="form-control">
                                              ...
                                              <option style="font-weight: bolder;" value="<?php echo e($i->id); ?>"><?php echo e($i->title); ?></option>
                                                <?php if(!empty($i->childs)): ?>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                            <input type="text" value="<?php echo e(old('sort_order')); ?>" name="sort_order" class="  form-control" placeholder="eg. 1">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <div class="radio-list">
                                              ...
                                              <input name="enable_plan_button_other" value="<?php echo e(old('enable_plan_button_other')); ?>" type="text" class="form-control">
                                      ...
                                      <div class="form-horizontal" id="frm_pricing">
                                          ...
                                          <div class="form-group ">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <div class="radio-list">
                                                ...
                                                <input   name="pricing_currency_other" value="<?php echo e(old('pricing_currency_other')); ?>" type="text" onblur="usd_to_rm(this.value)" class="curreny_other_class form-control">
                                                <div class="xss-margin"></div>
                                        ...
                                        <div hidden="" class="recurring_price">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <div class="radio-list">
                                                ...
                                                <input name="recurring_currency_other" value="<?php echo e(old('recurring_currency_other')); ?>" type="text" onchange="usd_to_rm(this.value)" class="curreny_other_class form-control">
                                                <div class="xss-margin"></div>
                                                <div class="text-blue text-12px">eg. 1 USD = 3.50 RM</div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                             <input name="recurring_first_month" value="<?php echo e(old('recurring_first_month')); ?>" type="text" class="form-control" placeholder="0.00">
                                         ...
                                         <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                           <input name="recurring_first_year" value="<?php echo e(old('recurring_first_year')); ?>" type="text" class="form-control" placeholder="0.00">
                      ...
                      <div id="plan-feature-details" class="tab-pane fade">
                        ...
                        <div class="portlet">
                                  ...
                                  <div class="modal-body">
                                    <div class="form">
                                      <form id="plan_feature_details_frm" class="form-horizontal">
                                        ...
                                        <input type="hidden" name="page" id="" value="<?php echo e($page_name); ?>">
                                        <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                          <div class="radio-list">
                                            <div class="xs-margin"></div>
                                            <label><input value="yes" id="optionsRadios1"   type="radio" name="select"/>&nbsp; Yes &nbsp; <i class="fa fa-check sitecolor" style="color: #006699;"></i></label>
                                            <div class="clearfix"></div>
                                            <label><input value="no" id="optionsRadios2" type="radio" name="select"/>&nbsp; No &nbsp; <i style="color: #D72D1A;" class="fa fa-times red"></i></label>
                                        ...
                                        <div class="form-actions">
                                          <div class="col-md-offset-5 col-md-8"> <button  id="save_feature_plan" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                        </div>
                                      </form>
                                    </div>
                                  </div>
                          ...
                          <div class="portlet-body">
                              ...
                              <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                  <form id="delete_client">
                                    ...
                                    <?php if(count($plan_features_details)>0): ?>
                                    <?php $count_plan_features = 0;?>
                                    <?php $__currentLoopData = $plan_features_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><a href="javascript:void" data-target="#modal-edit-plan-feature-<?php echo e($i->id); ?>" data-toggle="modal"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                                       <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-plan-feature-<?php echo e($i->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                       <!--Modal Edit plan feature start-->

                                       <!--Modal delete start-->
                                       <div id="modal-delete-plan-feature-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                            ...
                                            <div class="modal-body">
                                              <p><strong>#<?php echo e($i->id); ?>:</strong> <?php echo e($i->description); ?></p>
                                              <div class="form-actions">
                                                <div class="col-md-offset-4 col-md-8"> <button id="delete_single_button_pfd<?php echo e($i->id); ?>" onclick="delete_single(<?php echo e($i->id); ?>)" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div id="modal-edit-plan-feature-<?php echo e($i->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                        <div class="modal-dialog modal-wide-width">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                            ...
                                            <div class="modal-body">
                                              <div class="form form-horizontal"  id="pfd_edit_frm_<?php echo e($i->id); ?>">
                                             <?php echo e(csrf_field()); ?>
                                             ...
                                             <input type="hidden" name="page" value="<?php echo e($page_name); ?>">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-6">
                                                    <div data-on="success" data-off="primary" class="make-switch">
                                                      <input id="edit_pfd_status_<?php echo e($i->id); ?>" name="status" type="checkbox" <?php if($i->status==1): ?> checked="checked" <?php endif; ?> />
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="form-group">
                                             <label class="col-md-3 control-label">Plan Feature <span class="text-red">*</span></label>
                                          <div class="col-md-6">
                                            <select  id="edit_pfd_plan_feature_<?php echo e($i->id); ?>" name="plan_feature" class="form-control">
                                                <option value="">-- Please select --</option>
                                                  <?php if(count($plan_features)>0): ?>
                                                  <?php $__currentLoopData = $plan_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                      <option <?php if($i->plan_feature_id==$j->id): ?> selected <?php endif; ?> value="<?php echo e($j->id); ?>"><?php echo e($j->title); ?></option>
                                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                  <?php endif; ?>
                                              </select>
                                              <p class="red_error" id="edit_pfd_err_plan_feature"></p>
                                          </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-3 control-label">Description<span class="text-red">*</span></label>
                                            <div class="col-md-6">
                                              <input value="<?php echo e($i->description); ?>"  id="edit_pfd_description_<?php echo e($i->id); ?>"  name="description" type="text" class="form-control" placeholder="eg. RAM">
                                              <p class="red_error" id="edit_pfd_err_description"></p>
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                              <div class="radio-list">
                                                <div class="xs-margin"></div>
                                                <label><input value="yes" id="optionsRadios1"     type="radio" name="select" <?php if($i->select_yes_no=='yes'): ?> checked="" <?php endif; ?> />&nbsp; Yes &nbsp; <i class="fa fa-check sitecolor" style="color: #006699;"></i></label>
                                                <div class="clearfix"></div>
                                                <label><input value="no" <?php if($i->select_yes_no=='no'): ?> checked="" <?php endif; ?> id="optionsRadios2" type="radio" name="select"/>&nbsp; No &nbsp; <i style="color: #D72D1A;" class="fa fa-times red"></i></label>
                                                note to programmer: if choose yes/no, it will show "blue check icon with round bg" or "red cross icon with round bg" in the plan pricing table.
                                              </div>
                                            </div>
                                        </div>
                                        <div class="form-actions">
                                          <div class="col-md-offset-5 col-md-8"> <button type="button"  onclick="edit_pfd(<?php echo e($i->id); ?>)" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                        </div>
                            ...
                            <div class="clearfix"></div>
                            <span>Showing  <?php echo e($plan_features->firstItem()); ?> to <?php echo e($plan_features->lastItem()); ?> of <?php echo e($plan_features->total()); ?></span>
                      ...
                      <?php else: ?>
                          <div <?php if($is_ssl_page==1): ?> style="display:block" <?php endif; ?> class="portlet">
          <div class="portlet-header">
          ...
          <div class="portlet-body">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-actions">
                                  <div class="col-md-offset-4 col-md-8"> <a href="javascript:void" onclick="delete_single(<?php echo e($i->id); ?>)" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                </div>
                              </div>
                            </div>
                          </div>
                                        ...
                                        <div class="modal-body">
                                          <div class="form-horizontal">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <div data-on="success" data-off="primary" class="make-switch">
                                                    <input id="edit_pf_status_<?php echo e($i->id); ?>" type="checkbox" <?php if($i->status): ?> checked="checked" <?php endif; ?>/>
                                                  </div>
                                                </div>
                                              </div>
                                              <div class="form-group">
                        ...
                        <div class="portlet-body">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <input type="hidden" id="service_free_domains_id" name="id" value="<?php echo e(isset($service_free_domains)?$service_free_domains->id:''); ?>">
                              <input type="hidden" name="page" value="<?php echo e($page_name); ?>">
                                <div class="form-group">
                                  ...
                                  <div class="col-md-8">
                                    <div class="xss-margin"></div>
                                    <div class="radio-list">
                                      <label><input <?php if(isset($service_free_domains) && $service_free_domains->type==1): ?> checked <?php endif; ?>  name="type" id="inlineCheckbox1" type="radio" value="1" checked="checked"/>&nbsp; None</label>
                                      <label><input  <?php if(isset($service_free_domains) && $service_free_domains->type==2): ?> checked <?php endif; ?> name="type"  id="inlineCheckbox2" type="radio" value="2"/>&nbsp; Offer a free domain registration/transfer only (renew as normal)</label>
                                      <label><input <?php if(isset($service_free_domains) && $service_free_domains->type==3): ?> checked <?php endif; ?>  name="type"  id="inlineCheckbox3" type="radio" value="3"/>&nbsp; Offer a discounted domain registration/transfer only (renew as normal), please enter the first year fee (RM) below:</label>
                                      <input type="text" name="fee" id="service_free_domains_fee"  class="form-control numOnly" <?php if(isset($service_free_domains) && $service_free_domains->type==3): ?> value="<?php echo e($service_free_domains->fee); ?>" <?php endif; ?> placeholder="0.00" value="0.00">
                                      <label><input <?php if(isset($service_free_domains) && $service_free_domains->type==4): ?> checked <?php endif; ?> name="type"  id="inlineCheckbox4" type="radio" value="4"/>&nbsp; Offer a free domain registration/transfer and free renewal (if product is renewed)</label>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-5">
                                    <select name="tlds[]" multiple="multiple" class="form-control" style="height: 400px;">
                                       <?php if(count($single_domains)>0): ?>
                                              <?php $__currentLoopData = $single_domains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <option value="<?php echo e($i->id); ?>" <?php if(isset($service_free_domains)): ?> <?php if(in_array($i->id,$service_free_domains->tlds_array)): ?> selected <?php endif; ?> <?php endif; ?>><?php echo e($i->title); ?></option>
                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                      <?php endif; ?>
            ...
            <script type="text/javascript">
              ...
              $(document).on('submit', '#frm_genrel', function(event) {
                ...
                window.location.href=base_url+"/admin/services/edit/"+response+"/<?php echo e($page_slug); ?>";
      ...
      $.post(page_url+'get_details_pf_detail', {'id': id,'_token':csrf_token}, function(data, textStatus, xhr) {
        ...
        $(document).on('click', '#delete_bulk', function(event,form_id) {
          ...
          $(document).on('submit', '#plan_feature_details_frm', function(event) {
            ...
            .done(function() {
              window.location.href=base_url+"/admin/services/new/<?php echo e($page_slug); ?>?tab=plan-feature-details";
            })
             .fail(function(response) {
                  validation_errors=response.responseJSON;
              $.each(validation_errors, function(k, v) {
