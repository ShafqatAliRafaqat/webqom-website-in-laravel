...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page_title1 sty7">
        ...
        <div class="serch_area">
            ...
            <br/>
            <div class="molinks"><a href="<?php echo e(route('frontend.services', "bulk_domain_search")); ?>"><i class="fa fa-caret-right"></i> Bulk Domain Search</a>
            ...
            <div class="plan">
                <div class="container">
                    ...
                    <?php elseif($response->status_code == 0): ?>
                        <h3 class="light red"><i class="fa fa-times-circle"></i> Sorry! <strong><?php echo e($response->domain); ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php for($i = 1; $i <= count($prices); $i++): ?>
                                                <?php if($i == 1 || $i == 2 || $i == 3 || $i == 5 || $i == 10): ?>
                                                    <td class="alicent"><span class="red">RM <?php echo e($prices[$i]['s']); ?>
