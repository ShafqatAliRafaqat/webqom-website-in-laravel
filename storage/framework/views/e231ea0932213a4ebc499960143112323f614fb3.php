        ...
        <div class="col-lg-12">
            ...
            <div class="portlet">
                <div class="portlet-header">
                    <div class="caption">Edit Enquiry</div>&nbsp;

                </div>
                <div class="portlet-body">
                  <div class="row">
                    <div class="col-lg-10 col-lg-offset-1">
                      <form action=" <?php echo e(asset(route('enquires-update', $enquiry->id))); ?>" method="POST">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="service"  name="service" value="<?php echo e($enquiry->service); ?>">
                          </div>
                          <div class="form-group">
                              <label for="name">Name:</label>
                              <input type="text" class="form-control" id="name"  name="name" value="<?php echo e($enquiry->name); ?>">
                          </div>
                          <div class="form-group">
                              <label for="email">Email:</label>
                              <input type="email" class="form-control" id="email"  name="email" value="<?php echo e($enquiry->email); ?>">
                          </div>
                          <div class="form-group">
                              <label for="company">Company:</label>
                              <input type="text" class="form-control" id="company"  name="company" value="<?php echo e($enquiry->company); ?>">
                          </div>
                          <div class="form-group">
                              <label for="phone">Phone:</label>
                              <input type="text" class="form-control" id="phone"  name="phone" value="<?php echo e($enquiry->phone); ?>">
                          </div>
                          <div class="form-group">
                              <label for="website">Website:</label>
                              <input type="text" class="form-control" id="website"  name="website" value="<?php echo e($enquiry->website); ?>">
                          </div>
                          <div class="form-group">
                              <label for="message">Message:</label>
                              <textarea name="message" class="form-control" id="message"  name="message"><?php echo e($enquiry->message); ?></textarea>
                          </div>
                          <input type="submit" value="Update" class="btn btn-common">
                          <a href="<?php echo e(route('enquires-list')); ?>" class="btn btn-green">Back</a>
                      </form>
                    </div>
                  </div>
                </div>
