        ...
        <div class="plan">
            <div class="container">
                <div class="search_results">
                    <?php echo $__env->make('frontend.domain.partials.search_results', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
        </div>
        <!-- end plan 1 -->
...
<?php $__env->startSection('custom_scripts'); ?>
    ...
    <?php echo Html::style(url('resources/assets/frontend/css/loader.css')); ?>


    <?php echo Html::script(url('resources/assets/frontend/js/domain/domain-search.js')); ?>
