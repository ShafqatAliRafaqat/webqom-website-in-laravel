...
<?php $__env->startSection('title','Admin | Clients - Listing'); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startSection('page_header','Clients'); ?>
...
<div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              ...
              <?php if(isset($search_success)): ?>
                      <div class="alert alert-success alert-dismissable">
                                  <button type="button" data-dismiss="alert" aria-hidden="true" class="close">&times;</button>
                                  <i class="fa fa-check-circle"></i> <strong>Success!</strong>
                                  <p><?php echo e($search_success); ?></p>
                      </div>            
              <?php endif; ?> 
            ...
            <div class="col-md-12">
              <div class="portlet portlet-blue">
                ...
                <div class="portlet-body">
                  <form class="form-horizontal" action="<?php echo e(url('/clients/search_clients')); ?>" method="POST">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input autocomplete="off" name="client_id" value="<?php echo e(isset($_POST['client_id']) ? $_POST['client_id'] : ''); ?>" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-4 control-label">Client Name </label>
                        <div class="col-md-8">
                          <input autocomplete="off" name="client_name" value="<?php echo e(isset($_POST['client_name']) ? $_POST['client_name'] : ''); ?>" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-4 control-label">Email </label>
                        <div class="col-md-8">
                          <input autocomplete="off" name="email" value="<?php echo e(isset($_POST['email']) ? $_POST['email'] : ''); ?>" type="text" class="form-control">
                        </div>
                      </div>
                    </div>
                    <!-- end col-md 6 -->
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input autocomplete="off" name="company" value="<?php echo e(isset($_POST['company']) ? $_POST['company'] : ''); ?>" type="text" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <div class="input-group">
                            <input type="text" autocomplete="off" id="created_date" value="<?php echo e(isset($_POST['created_date']) ? $_POST['created_date'] : ''); ?>" name="created_date" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy" class="datepicker-default form-control" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <select  autocomplete="off" name="account_type" class="form-control">
                            ...
                            <option <?php if(isset($_POST['account_type']) && $_POST['account_type']=="Business Account"): ?> selected="" <?php endif; ?>>Business Account</option>
                            <option <?php if(isset($_POST['account_type']) && $_POST['account_type']=="Individual Account"): ?> selected="" <?php endif; ?>>Individual Account</option>
                          </select>
                        </div>
                        <?php echo e(old('account_type')); ?>
              ...
              <div class="portlet">
                <div class="portlet-header">
                 ...
                 <div class="btn-group">
                  ...
                  <a href="<?php echo e(url('/clients/export')); ?>" class="btn btn-blue">Export to CSV &nbsp;<i class="fa fa-share"></i></a>  
                  <div class="tools"> <i class="fa fa-chevron-up"></i> </div>
                ...
                <div class="portlet-body">
                  ...
                  <div class="table-responsive mtl">
                    ...
                    <table id="clients_list" class="table table-hover table-striped">
                      ...
                      <?php if(!empty($clients)): ?>
                            ...
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    ...
                                    <tr id="clienttbl_row_<?php echo e($client->id); ?>">
                                      <td><input name="id[]" value="<?php echo e($client->id); ?>" type="checkbox"/></td>
                                      <td><?php echo e($count); ?></td>
                                      <td><?php echo e(isset($client->client_id) ? $client->client_id : ""); ?></td>
                                      <td><?php echo e($client->first_name." ".$client->last_name); ?></td>
                                      <td><a href="mailto:danny@webqom.com"><?php echo e($client->email); ?></a></td>
                                      <td><?php echo e($client->company); ?></td>
                                      <td><?php echo e(date("d-M-Y",strtotime($client->created_at))); ?></td>
                                      <td><?php echo e($client->account_type); ?></td>
                                      <td><span class="label label-xs label-<?php echo  $client->status==1 ? "success" :"red" ?>"><?php echo  $client->status==1 ? "Active" :"Inactive" ?></span></td>
                                      <td><a href="<?php echo e(url('/clients/edit').'/'.$client->id); ?>" data-hover="tooltip" data-placement="top" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-<?php echo e($client->id); ?>" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                          <!--Modal delete start-->
                                          <div id="modal-delete-<?php echo e($client->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                                ...
                                                <div class="modal-body">
                                                  <p><strong>#<?php echo e(isset($client->client_id) ? $client->client_id : ""); ?>:</strong> <?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?><br/>
                                                      <strong>Company:</strong> <?php echo e($client->company); ?> </p>
                                                  <div class="form-actions">
                                                    <div class="col-md-offset-4 col-md-8"> <button type="button" id="delete_single_button" class="btn btn-red" onclick="delete_single(<?php echo e($client->id); ?>)">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                    ...
                    <?php if ($clients instanceof \Illuminate\Pagination\LengthAwarePaginator){ ?>
						<span> Showing <?php echo e(($clients->currentpage()-1)*$clients->perpage()+1); ?> to <?php echo e((($clients->currentpage()-1)*$clients->perpage())+$clients->count()); ?> of <?php echo e($clients->total()); ?> </span>
                      <span class="pull-right"><?php echo e($clients->links()); ?></span>
                    <?php }else{ ?>
                      <span>Total records: <?php echo e(count($clients)); ?></span>
                    <?php } ?>
