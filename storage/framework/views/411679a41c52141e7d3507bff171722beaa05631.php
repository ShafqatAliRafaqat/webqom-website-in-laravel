...
<script src="<?php echo e(url('').'/resources/assets/frontend/'); ?>jquery.min.js" type="text/javascript"></script>
...
<script src="<?php echo e(url('').'/resources/assets/frontend/'); ?>js/jqueryValidation/js/jquery.validate.min.js"></script>
<script src="<?php echo e(url('').'/resources/assets/frontend/'); ?>js/jqueryValidation/js/additional-methods.min.js"></script>
