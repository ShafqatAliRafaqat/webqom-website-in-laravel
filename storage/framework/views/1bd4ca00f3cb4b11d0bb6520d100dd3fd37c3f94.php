...
<div class="parallax_section2">
    <div class="accordion">
        <?php if(count($email88_special_features)>0): ?>
        <div class="container">
            <h1 class="caps"><strong><?php echo $email88_special_features[0]['attributes']['heading']; ?></strong></h1>
            <h2 class="light"><?php echo $email88_special_features[0]['attributes']['sub_heading']; ?></h2>
            <div class="clearfix margin_bottom2"></div>
            <div id="st-accordion-four" class="st-accordion-four alileft">
                <p><?php echo $email88_special_features[0]['attributes']['content']; ?></p>
                <ul>
                    <?php $__currentLoopData = $email88_special_features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email88): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <li>
                        <a href="#"><?php echo e($email88->title); ?><span class="st-arrow">Open or Close</span></a>
                        <div class="st-content">
                            <?php echo $email88->description; ?>

                            <?php $__currentLoopData = explode(',', $email88->icon_image); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
