...
<div class="page_title1 sty7">
    ...
    <div class="serch_area">
        <form method="get">
            <input class="enter_email_input" name="login_domain" id="samplees"
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($response->status == 0): ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                <?php else: ?>
                                    <a href="http://<?php echo e($response->domain); ?>" target="_blank">WWW</a> | <a
                                            href="<?php echo e(route('frontend.domain.whois', $response->domain)); ?>">WHOIS</a>
                                <?php endif; ?>
