<?php $__env->startSection('title','Registration | - Webqom Technologies'); ?>
<?php $__env->startSection('page_header','Create an Account'); ?>
<?php $__env->startSection('breadcrumbs','Create an Account'); ?>
...
<div class="container" >
	...
	<div class="one_full_less">
    	<p>By creating an account with us you will be able to shop faster, be up to date on an orders status, and keep track of the orders you have previously made. Enjoy exclusive discounts and offers. If you already have an account with us, please login at the <a class="red" href="<?php echo e(url('/login')); ?>">login</a> page.</p>
