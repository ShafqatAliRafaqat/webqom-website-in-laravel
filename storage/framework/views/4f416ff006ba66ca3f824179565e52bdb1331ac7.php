...
<link type="text/css" rel="stylesheet" href="<?php echo e(url('').'/resources/assets/admin/'); ?>icons/font-awesome.min.css">
<meta charset="utf-8">
  ...
  <div id="wrapper"><!--BEGIN TOPBAR-->
        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                  ...
                  <li><a href="billing_quote_new.html"><i class="fa fa-plus fa-fw"></i><span class="menu-title">Add New Quote</span></a></li>
                    ...
                    <li  <?php if(isset($page) && $page=='categories'): ?> class="active" <?php endif; ?>><a href="<?php echo e(url('/admin/categories')); ?>"><i class="fa fa-cog fa-fw"></i><span class="menu-title">Categories</span></a> </li>
          ...
          <li><a href="promo_codes_list.html"><i class="fa fa-qrcode fa-fw"></i><span class="menu-title">Promo Codes</span></a></li>
                    ...
                    <li <?php if(isset($page) && $page=='blog'): ?> class="active mm-active" <?php endif; ?>><a href="<?php echo e(route('admin.articles.index')); ?>"><i class="fa fa-check-circle fa-fw"></i><span class="menu-title">Blog</span></a></li>
                    <li><a href="#" <?php if(isset($page) && $page=='blog'): ?> aria-expanded="true" <?php endif; ?>><i class="fa fa-globe fa-fw"></i><span class="menu-title">Domains</span><span class="fa arrow"></span></a>
                      <ul class="nav nav-second-level">
              ...
              <li><a href="single_domain_search_edit.html">Single Domain Search</a></li>
                          ...
                          <li <?php if(\Request::route()->getName() == 'edit_single_domain_transfer_page'): ?> class="active" <?php endif; ?> >
                              <a href="<?php echo e(route('edit_single_domain_transfer_page')); ?>" >Single Domain Transfer</a></li>
