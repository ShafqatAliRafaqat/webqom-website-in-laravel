    ...
    $('#side-menu').metisMenu().on('shown.metisMenu', function(event) {
        ...
        if (menu_h > temp_page_content_height) {
            ...
            $('.page-content').css('min-height', temp_page_content_height + 'px');
        }
     }).on('hidden.metisMenu', function(event) {
        $('.page-content').css('min-height', page_content_height);
     });
    ...
    if (page_content_height < menu_h) {
        ...
        $('.page-content').css('min-height', page_content_height + 'px');
    }
    /*** Menu SideBar ***/
    /*******************/
