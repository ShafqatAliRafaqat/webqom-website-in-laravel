...
<div class="page_title1 sty7">
    ...
    @if(isset($response) && $response->status_code != -1)
    ...
    <div class="clearfix"></div> 
        ...
        <div class="container">
            ...
            <h3 class="light red"><i class="fa fa-times-circle"></i> Sorry! <strong>{{$response->domain}} does not appear to be registered yet.</strong> Try registering this domain instead.</h3>
            @else
            ...
            <h3 class="light red"><i class="fa fa-times-circle"></i> Sorry! Your domain is <strong>LOCKED</strong> and cannot be transferred without being unlocked.</h3>
                @else
                <h3 class="light green"><i class="fa fa-check-circle"></i> Congratulations! <strong>{{$response->domain}}</strong> is eligible for transfer!</h3>
                @endif
            @endif
