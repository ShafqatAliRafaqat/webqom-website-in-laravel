            <?php $page='categories';
            $breadcrumbs=[
            array('url'=>url('admin/cloud_hosting'),'name'=>'Vps Hosting'),
            array('url'=>'javascript:void','name'=>'Vps Hosting- Edit'),

            ];
            ?>

            @extends('layouts.admin_layout')
            @section('title','Admin | Vps Hosting- Edit')
            @section('content')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="frm_genrel" class="form-horizontal" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                      <input value="{{$plan->plan_name}}" name="plan_name" type="text" class="form-control" placeholder="eg. L Vps">
