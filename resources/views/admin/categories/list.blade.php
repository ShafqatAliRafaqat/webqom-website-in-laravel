                    ...
                    <div id="nestable" class="dd">
                        <ol class="dd-list">
                            ...
                            <li data-id="{{$i->id}}" class="dd-item">
                                ...
                                <div class="dd-handle"> {{$i->title}}
                                    <span class="label label-sm label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span>


                                    <div class="pull-right dd-nodrag">
                                        <a href="javascript:void" onclick="duplicate({{$i->id}})" data-hover="tooltip" data-placement="top" title="Duplicate/New Category"><span class="label label-sm label-blue"><i class="fa fa-copy"></i></span></a>
                                        <a href="#" data-hover="tooltip" data-placement="top"  data-target="#modal-edit-{{$i->id}}" data-toggle="modal" title="Edit" onclick="editmodal()"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                                        <!-- <a href="{{url('admin/index-plan')}}" data-hover="tooltip" data-placement="top" title="Add Plan &amp; Page Edit"><span class="label label-sm label-warning"><i class="fa fa-plus"></i></span></a> -->
                                        <a class="@if(strtolower($i->title)=='ssl certificates') hidden @endif" href="javascript:void" onclick="upload_category_images({{$i->id}})"  title="Upload Menu Image"><span class="label label-sm label-dark"><i class="fa fa-image"></i></span></a>
                                        <a  class="@if(strtolower($i->title)!='ssl certificates') hidden @endif" href="{{url('admin/services/'.$i->slug)}}" data-hover="tooltip" data-placement="top" title="{{$i->title}} Page Edit"><span class="label label-sm label-warning"><i class="fa fa-plus"></i></span></a>
                                        <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-{{$i->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>                                                        </div>
                                </div>
                                    ...
                                    <li data-id="{{$j->id}}" class="dd-item">
                                        <div class="dd-handle">{{$j->title}}
                                            ...
                                            <div class="pull-right dd-nodrag">
                                                ...
                                                <a href="javascript:void" data-hover="tooltip" data-placement="top"  data-target="#modal-edit-{{$j->id}}" data-toggle="modal" onclick="editmodal()" title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a>
                                                <a href="{{url('admin/services/'.$j->slug)}}" data-hover="tooltip" data-placement="top" title="{{$j->title}} Page Edit"><span class="label label-sm label-warning"><i class="fa fa-plus"></i></span></a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-actions">
                                                        <div class="col-md-offset-4 col-md-8"> <button onclick="delete_single({{$j->id}})" class="btn_delete btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="modal-edit-{{$j->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                                ...
                                                <div class="modal-body">
                                                    <div class="form">
                                                        <form id="sub_cat_{{$j->id}}" class="sub_edit_form form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div data-on="success" style="    height: 35px;" data-off="primary" class="make-switch">
                                                                        <input  name="status" type="checkbox" @if($j->status)checked="checked" @endif/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input name="title" type="text" class="form-control" placeholder="eg. RAM" value="{{$j->title}}">
                                                                    <p id="{{$j->id}}_error_edit_title" class="red_error"></p>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">Short Description<span class="text-red">*</span></label>
                                                                <div class="col-md-6">
                                                                    <input name="description" type="text" class="form-control" placeholder="eg. RAM" value="{{$j->description}}">
                                                                    <p id="{{$j->id}}_error_edit_description" class="red_error"></p>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label">Insert CSS icon <span class="text-red">*</span></label>
                                                                <div class="col-md-6">
                                                                    <input name="icon" type="text" class="form-control" placeholder="eg. RAM" value="{{$j->icon}}">
                                                                    <p id="{{$j->id}}_error_edit_icon" class="red_error"></p>
                                                            ...
                                                            <div class="form-group" style="display:none;" >
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input @if($j->is_ssl_page==1) checked="checked" @endif name="is_ssl_page" type="checkbox" placeholder="eg. RAM" value="1" class="page_type">
                                                                </div>
                                                            </div>
                                                            <div class="form-group" style="display:none;" >
                                                                <label class="col-md-6 control-label">Ecomerce Page<span class="text-red">*</span></label>
                                                                <div class="col-md-6">
                                                                    <input @if($j->is_ecomerce_page==1) checked="checked" @endif name="is_ecomerce_page" type="checkbox" placeholder="eg. RAM" value="1" class="page_type">
                                                                </div>
                                                            </div>

                                                            <div class="form-actions">
                                                                <div class="col-md-offset-5 col-md-8"> <a href="javascript:void" onclick="update_sub_cat({{$j->id}})" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                            ...
                            @endif
                            <div id="modal-edit-{{$i->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                                        ...
                                        <div class="modal-body">
                                            <div class="form">
                                                <form id="sub_cat_{{$i->id}}" class="sub_edit_form form-horizontal">
                                                    <input type="hidden" id="edit_id" name="id">
                                                    {!!csrf_field()!!}
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Status</label>
                                                        <div class="col-md-6">
                                                            <div data-on="success" style="    height: 35px;" data-off="primary" class="make-switch">
                                                                <input  name="status" type="checkbox" @if($i->status)checked="checked" @endif/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Category <span class="text-red">*</span></label>
                                                        <div class="col-md-6">
                                                            <input name="title" type="text" class="form-control" placeholder="eg. RAM" value="{{$i->title}}">
                                                            <p id="{{$i->id}}_error_edit_title" class="red_error"></p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    <label class="col-md-3 control-label">Short Description<span class="text-red">*</span></label>
                                                    <div class="col-md-6">
                                                        <input name="description" type="text" class="form-control" placeholder="eg. RAM" value="{{$i->description}}">
                                                        <p id="{{$i->id}}_error_edit_description" class="red_error"></p>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Insert CSS icon <span class="text-red">*</span></label>
                                                    <div class="col-md-6">
                                                        <input name="icon" type="text" class="form-control" placeholder="eg. RAM" value="{{$i->icon}}">
                                                        <p id="{{$i->id}}_error_edit_icon" class="red_error"></p>
                                                    </div>
                                                </div>
                                                    <div class="form-actions">
                                                        <div class="col-md-offset-5 col-md-8"> <a href="javascript:void" onclick="update_sub_cat({{$i->id}})" class="btn btn-red">Save &nbsp;<i class="fa fa-floppy-o"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
