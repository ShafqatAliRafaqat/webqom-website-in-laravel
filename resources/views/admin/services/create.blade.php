...
<div  class="tab-content">
  ...
  <div id="general-pricing" class="tab-pane fade in active">
    <form id="frm_genrel" class="form-horizontal" action="{{url('/admin/services/new_hosting_plan')}}" method="POST" enctype="multipart/form-data">
      <div class="portlet">
                    ...
                    <p class="red_error" id="status"></p>
                                      ...
                                      <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                            ...
                                            <select name="category" class="form-control">
                                              ...
                                              <option style="font-weight: bolder;" value="{{$i->id}}">{{$i->title}}</option>
                                                @if(!empty($i->childs))
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-6">
                                            <input type="text" value="{{old('sort_order')}}" name="sort_order" class="  form-control" placeholder="eg. 1">
                              ...
                              <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                  <form id="delete_client">
                                    {!!csrf_field()!!}
                                    @if(count($plan_features_details)>0)
                                    <?php $count_plan_features = 0;?>
                                    @foreach($plan_features_details as $i)
                                        ...
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              ...
                                              <div class="form-actions">
                                                <div class="col-md-offset-4 col-md-8"> <button id="delete_single_button_pfd{{$i->id}}" onclick="delete_single({{$i->id}})" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                            ...
                                            <div class="modal-body">
                                             ...
                                             <input type="hidden" name="page" value="{{$page_name}}">
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-6">
                                                    <div data-on="success" data-off="primary" class="make-switch">
                                                      <input id="edit_pfd_status_{{$i->id}}" name="status" type="checkbox" @if($i->status==1) checked="checked" @endif />
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <select  id="edit_pfd_plan_feature_{{$i->id}}" name="plan_feature" class="form-control">
                                                <option value="">-- Please select --</option>
                                                  ...
                                                  @foreach($plan_features as $j)
                                                      <option @if($i->plan_feature_id==$j->id) selected @endif value="{{$j->id}}">{{$j->title}}</option>
                                                  @endforeach
                                                  @endif
                                              </select>
                                         ...
                                         <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                              <div class="radio-list">
                                                <div class="xs-margin"></div>
                                                <label><input value="yes" id="optionsRadios1"     type="radio" name="select" @if($i->select_yes_no=='yes') checked="" @endif />&nbsp; Yes &nbsp; <i class="fa fa-check sitecolor" style="color: #006699;"></i></label>
                                                <div class="clearfix"></div>
                                                <label><input value="no" @if($i->select_yes_no=='no') checked="" @endif id="optionsRadios2" type="radio" name="select"/>&nbsp; No &nbsp; <i style="color: #D72D1A;" class="fa fa-times red"></i></label>
                                                note to programmer: if choose yes/no, it will show "blue check icon with round bg" or "red cross icon with round bg" in the plan pricing table.
                                              </div>
                                            </div>
                                        </div>
          ...
          <div class="portlet-body">
                        ...
                        <div class="portlet-body">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              {{csrf_field()}}
                              <input type="hidden" id="service_free_domains_id" name="id" value="{{isset($service_free_domains)?$service_free_domains->id:''}}">
                              <input type="hidden" name="page" value="{{$page_name}}">
                                <div class="form-group">
            ...
            <script type="text/javascript">
              ...
              $(document).on('submit', '#frm_genrel', function(event) {
                ...
                window.location.href=base_url+"/admin/services/edit/"+response+"/{{$page_slug}}";
      ...
      $.post(page_url+'get_details_pf_detail', {'id': id,'_token':csrf_token}, function(data, textStatus, xhr) {
        ...
        $(document).on('click', '#delete_bulk', function(event,form_id) {
          ...
          $(document).on('submit', '#plan_feature_details_frm', function(event) {
            ...
            .done(function() {
              window.location.href=base_url+"/admin/services/new/{{$page_slug}}?tab=plan-feature-details";
            })
             .fail(function(response) {
                  validation_errors=response.responseJSON;
              $.each(validation_errors, function(k, v) {
