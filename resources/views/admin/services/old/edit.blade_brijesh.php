      ...
      <div class="portlet-header">
        ...
        <div class="btn-group">
          ...
          <ul role="menu" class="dropdown-menu">
            ...
            <li><a href="javascript:void" onclick="delete_multi()" >Delete selected item(s)</a></li>
            
            <li class="divider"></li>
            <li><a href="#" data-target="#modal-delete-all" data-toggle="modal" onclick="delete_all()">Delete all</a></li>
          </ul>
        </div>
        <!--Modal Add New plan feature start-->
        ...
        <div class="table-responsive mtl">
          <table class="table table-hover table-striped">
            ...
            <tbody>
              ...
              @if(count($plan_features))

                data is is not empty {{ count($plan_features)}}
              @else
                This is some data {{$plan_features}}
              @endif
                 {!!csrf_field()!!}
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-actions">
                              <div class="col-md-offset-4 col-md-8"> <a href="javascript:void" onclick='delete_single({{$i->id}}, event)' class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i class="fa fa-times-circle"></i></a> </div>
                            </div>
                          </div>
                        </div>
                      </div>
