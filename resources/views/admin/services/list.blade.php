                                            ...
                                            @if(count($faq)>0)
                                                @foreach($faq as $i)
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript:void" onclick="store_faq({{$i->id}})"
                                                               title="Edit"><span
                                                                        class="label label-sm label-success"><i
                                                                            class="fa fa-pencil"></i></span></a> <a
                                                                    href="#"
                                ...
                                <div class="table-responsive mtl">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>
                                                <span class="label label-xs label-{{$general_features[0]['heading_status']?'success':'danger'}}">{{$general_features[0]['heading_status']?'Active':'Inactive'}}</span>
                                            </td>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div data-on="success"
                                                                                     ...
                                                                                     class="make-switch">
                                                                                    <input name="status" type="checkbox"
                                                                                           @if($general_features[0]['heading_status']==1) checked="checked" @endif/>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="text" name="heading"
                                                                                       class="form-control"
                                                                                       value="{{$general_features[0]['heading']}}">
                                                                                <p class="red_error"
                                                                                   id="gf_heading"></p>
                                                                            </div>
                                                                        </div>
