...
array('url'=>url('admin/cloud_hosting'),'name'=>'Cloud Hosting Page'),
array('url'=>'javascript:void','name'=>'Cloud Hosting- Add new'),
];
?>
@extends('layouts.admin_layout')
@section('title','Admin | Cloud Hosting- New')
@section('content')
@section('page_header','Services')
    ...
    <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Cloud Hosting <i class="fa fa-angle-right"></i> Add New</h2>
...
@section('custom_scripts')
    <script type="text/javascript">
        ...
        $(document).on('submit', '#frm_genrel', function(event) {
            ...
            $.ajax({
                url: base_url+'/admin/cloud_hosting/new_plan',
                type: 'POST',
                data: formData,
