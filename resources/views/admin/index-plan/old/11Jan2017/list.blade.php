...
<div class="page-content">
                    ...
                    <div class="portlet-header">
                      ...
                      <div class="modal-content">
                        ...
                        <div id="delete-selected-body-information"></div>
                          <p id="selected_zero" style="display:none" class="alert alert-danger">Please select atleast one item for delete</p>
                      ...
                      <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                              <?php $count_videos++  ?>
                                <td><input type="checkbox" class="video_checkbox"></td>
                                <td>{{$count_videos}}</td>
                                <td><span class="label label-xs label-{{$i->status?'success':'danger'}}">{{$i->status?'Active':'Inactive'}}</span></td>
                                <td>{{$i->heading}}</td>
                                <td>{{$i->video_title}}</td>
                ...
                <table class="table table-hover table-striped">
                  ...
                  @if(count($offer_services)>0)
                    <tr>
                      ...
                      <td><span class="label label-xs label-{{$general_features[0]['heading_status']?'success':'danger'}}">{{$offer_services[0]['heading_status']?'Active':'Inactive'}}</span></td>
                                ...
                                <div class="form">
                                  <form id="frm_offer_services_heading" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      <label class="col-md-3 control-label">Status</label>
                                      <div class="col-md-6">
                                        <div data-on="success" data-off="primary" offer_services="make-switch">
                                          <input name="status" type="checkbox" @if($general_features[0]['heading_status']==1) checked="checked" @endif/>
                                        </div>
                                      </div>
                                    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" id="delete-selected-body">
          <div id="delete-selected-body-information"></div>
          <p id="selected_zero" style="display:none" class="alert alert-danger">Please select atleast one record for delete</p>
          <div class="form-actions" id="delete-selected-buttons">
