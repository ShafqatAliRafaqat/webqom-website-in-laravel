...
array('url'=>'javascript:void','name'=>'Shared Hosting- Edit'),
];
?>
@extends('layouts.admin_layout')
@section('title','Admin | Shared Hosting- Edit')
@section('content')
@section('page_header','Services')
<div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Shared Hosting <i class="fa fa-angle-right"></i> Edit</h2>
              ...
              <div class="portlet">
                ...
                <div class="portlet-body">
                  ...
                  <div  id="left_content" contenteditable="true">
                    {!!$page_cms->left_content!!}
                  </div>
                   
                    <!-- end plan 2 -->
                    <div id="right_content" contenteditable="true">
                      {!!$page_cms->right_content!!}
                    </div>
                    <!-- end plan 3 -->
                    <div class="clearfix"></div>
                  </div>
                ...
                <div class="form-actions none-bg"> <a onclick="save_content(0)" href="javascript:void" class="btn btn-red">Save &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp; <a href="#publish online" class="btn btn-blue">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i></a>&nbsp; <a href="#" class="btn btn-green">Cancel &nbsp;<i class="glyphicon glyphicon-ban-circle"></i></a> </div>
                <!-- save button end -->
              </div>
              <!-- end porlet -->
              
              <h4 class="block-heading">Shared Hosting Plans &amp; General Features Listing</h4>
              ...
              <ul id="myTab" class="nav nav-tabs">
                <li class="active"><a href="#hosting-plans" data-toggle="tab">Shared Hosting Plans</a></li>
              ...
              <div id="myTabContent" class="tab-content">
                <div id="hosting-plans" class="tab-pane fade in active">
                  ...
                  <div class="portlet">
                    <div class="portlet-header">
                      <div class="caption">Shared Hosting Plans Listing</div>
                      <p style="margin-top: 32px" class="margin-top-10px"></p>
                      <a href="{{url('admin/shared_hosting/new')}}" class="btn btn-success">Add New Plan &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                      <div class="btn-group">
                        <button type="button" class="btn btn-primary">Delete</button>
                        <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
                        <ul role="menu" class="dropdown-menu">
                        ...
                        <table class="table table-hover table-striped">
                          ...
                          <tbody>
                            ...
                            @if(!empty($hosting_plan))
                              ...
                              <td><a href="{{url('/admin/shared_hosting/edit/'.$i->id)}}"  title="Edit"><span class="label label-sm label-success"><i class="fa fa-pencil"></i></span></a> <a href="#" data-hover="tooltip" data-placement="top" title="Delete" data-target="#modal-delete-plan-feature-{{$i->id}}" data-toggle="modal"><span class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                  <!--Modal Edit plan feature start-->
...
<script type="text/javascript">
  ...
  $(document).on('submit', '#plan_feature_frm', function(event) {
    ...
    $.ajax({
      url: base_url+'/admin/shared_hosting/new',
      type: 'POST',
  ...
  $(document).on('click', '#edit_plan_feature', function(event) {
      $.ajax({
      url: base_url+'/admin/shared_hosting/update',
      type: 'POST',
    ...
    */var left_content = CKEDITOR.instances.left_content.getData();
    ...
    console.log(left_content)
     ...
     function delete_single(id,type) {
                      ...
                      $.ajax({
                      url: base_url+'/admin/shared_hosting/delete',
                      type: 'POST',
                  ...
                  if (selected<1) {
                    ...
                    $.ajax({
                      url: base_url+'/admin/shared_hosting/get_details',
                      type: 'POST',
                ...
                function open_modal_delete_selected_hp() {
                  ...
                  if (selected<1) {
                    ...
                    /*get seleccted users details*/
                    $.ajax({
                      url: base_url+'/admin/shared_hosting/get_details_hp',
                      type: 'POST',
      ...
      $(document).on('click', '#delete_bulk_hp', function(event,form_id) {
                  ...
                  if (selected<1) {
                    ...
                    $.ajax({
                      url: base_url+'/admin/shared_hosting/delete_hp',
                      type: 'POST',
               ...
               $.ajax({
                 url:base_url+'/admin/shared_hosting/delete_all_plans',
                 type: 'POST',
                 data: {'_token': csrf_token},
               })
               .done(function() {
         ...
         $.ajax({
           url: base_url+'/admin/shared_hosting/update_sort',
           type: 'POST',
