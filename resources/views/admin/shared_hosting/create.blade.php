...
array('url'=>url('admin/shared_hosting'),'name'=>'Shared Hosting Page'),
array('url'=>'javascript:void','name'=>'Shared Hosting- Add New'),
];
?>

@extends('layouts.admin_layout')
@section('title','Admin | Shared Hosting- New')
@section('content')
@section('page_header','Services')
    ...
    <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Shared <i class="fa fa-angle-right"></i> Add New</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="frm_genrel" class="form-horizontal" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <input name="plan_name" type="text" class="form-control" placeholder="eg. L Shared">
                                                                      ...
                                                                      <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                          ...
                                                                          <!--<select class="form-control">
                                                                            ...
                                                                            note to programmer: the list of plan features is added from "shared_hosting_edit.html" page.-->
                                                                        </div>
                                                                      </div>
                                                                      <!--<div class="form-group">
                                                                        <label class="col-md-3 control-label">Description </label>
...
@section('custom_scripts')
    <script type="text/javascript">
        ...
        $(document).on('submit', '#frm_genrel', function(event) {
            ...
            $.ajax({
                url: base_url+'/admin/shared_hosting/new_plan',
                type: 'POST',
                data: formData,
