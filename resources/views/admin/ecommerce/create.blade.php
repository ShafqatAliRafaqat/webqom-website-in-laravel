...
array('url'=>url('admin/ecommerce'),'name'=>'Ecommerce Page'),
array('url'=>'javascript:void','name'=>'Ecommerce- Add New'),
];
?>

@extends('layouts.admin_layout')
@section('title','Admin | Ecommerce- New')
@section('content')
@section('page_header','Services')
    ...
    <div class="page-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Ecommerce <i class="fa fa-angle-right"></i> Add New</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="frm_genrel" class="form-horizontal" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                  <input name="plan_name" type="text" class="form-control" placeholder="eg. L Dedicated">
                                                                      ...
                                                                      <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                          ...
                                                                          <!--<select class="form-control">
                                                                            ...
                                                                            note to programmer: the list of plan features is added from "ecommerce_edit.html" page.-->
                                                                        </div>
                                                                      </div>
                                                                      <!--<div class="form-group">
                                                                        <label class="col-md-3 control-label">Description </label>
...
@section('custom_scripts')
    <script type="text/javascript">
        ...
        $(document).on('submit', '#frm_genrel', function(event) {
            ...
            $.ajax({
                url: base_url+'/admin/ecommerce/new_plan',
                type: 'POST',
                data: formData,
