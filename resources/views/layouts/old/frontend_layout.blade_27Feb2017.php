...
<?php if (Route::getCurrentRoute()->uri()!="/" && Route::getCurrentRoute()->uri()!="services/{page}" && Route::getCurrentRoute()->uri()!="services/{page}/{preview?}") { ?>
<div class="clearfix">
                      ...
                      <div class="row">
                        ...
                        <div class="mega-menu-contnew">
                            ...
                            <div class="section-box">
                                @foreach($child as $j)
                                <a href="{{url('/services/'.$j->slug)}}"><i class="fa fa-cloud"></i> <strong>{{$j->title}}</strong> {{$j->description}}</a>
