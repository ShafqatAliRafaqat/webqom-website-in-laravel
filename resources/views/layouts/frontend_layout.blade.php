...
<script src="{{url('').'/resources/assets/frontend/'}}js/jqueryValidation/js/jquery.validate.min.js"></script>
<script src="{{url('').'/resources/assets/frontend/'}}js/jqueryValidation/js/additional-methods.min.js"></script>
